                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <?php if($this->login_user->user_type == "staff"){ ?>
                               <li role="presentation">
                                    <?php echo modal_anchor(get_uri("estimate_requests/edit_estimate_request_modal_form"), "<i class='fa fa-pencil'></i> " . lang('edit'), ["title" => lang('estimate_request'), "data-post-view" => "details", "data-post-id" => $model_info->id]); ?>
                                </li>
								<?php
							}
							...
							<?php if($this->login_user->user_type == "staff"){ ?>
                               <li role="presentation">
                                    <?php echo modal_anchor(get_uri("estimates/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_estimate'), ["title" => lang('add_estimate'), "data-post-estimate_request_id" => $model_info->id, "data-post-client_id" => $model_info->client_id]); ?>
                                </li>
							<?php } ?>
                        </ul>
                    </span>
            ...
            <div class="p15">
				...
				if($model_info->files)
				{
					...
					if($total_files && $show_download_option)
					{
						...
						echo anchor(get_uri("estimate_requests/download_estimate_request_files/" . $model_info->id), $download_caption, ["class" => "pull-right", "title" => $download_caption]);
					}
				}
				?>
            </div>
