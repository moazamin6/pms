   ...
   <div id="estimate-form-editable" class="panel panel-default  p15 no-border clearfix" style="max-width: 1000px; margin: auto;">
      <div class="clearfix pl10 pr10">
         <h3 id="estimate-form-title" class="pull-left"> <?php echo $model_info->title; ?></h3>
		  <?php echo anchor(get_uri("estimate_requests/preview_estimate_form/" . $model_info->id), lang('preview'), ["class" => "btn btn-default round mt15 pull-right", "title" => lang('preview')]); ?>
      </div>
      ...
      <div class="p15">
         <div class='text-center'> <?php echo modal_anchor(get_uri("estimate_requests/estimate_form_field_modal_form/" . $model_info->id), "<i class='fa fa-plus-circle'></i> " . lang('add_field'), ["class" => "btn btn-default round ", "title" => lang('add_field')]); ?> </div>
      </div>
   </div>
</div>
