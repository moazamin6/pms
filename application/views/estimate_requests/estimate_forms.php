   ...
   <div class="panel panel-default">
      <div class="page-title clearfix">
         ...
         <div class="title-button-group">
			 <?php echo modal_anchor(get_uri("estimate_requests/estimate_request_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_form'), ["class" => "btn btn-default", "title" => lang('add_form')]); ?>
         </div>
      </div>
