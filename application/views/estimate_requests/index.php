      ...
      <div class="page-title clearfix">
         ...
         <div class="tab-title clearfix no-border">
            <div class="title-button-group">
				<?php echo modal_anchor(get_uri("estimate_requests/request_an_estimate_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('create_estimate_request'), ["class" => "btn btn-default", "title" => lang('create_estimate_request')]); ?>
            </div>
         </div>
      </div>
...
<script type="text/javascript">
   $(document).ready(function () {
      $("#estimate-request-table").appTable({
         ...
         order: [[4, 'desc']],
         filterDropdown: [{name: "assigned_to", class: "w150", options: <?php echo $assigned_to_dropdown; ?>}, {
            name: "status",
            class: "w150",
