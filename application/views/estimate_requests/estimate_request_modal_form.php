<div class="modal-body clearfix">
	...
	<?php echo form_open(get_uri("estimate_requests/save_estimate_request_form"), ["id" => "estimate-form", "class" => "general-form", "role" => "form"]); ?>
   ...
   <div class="form-group">
      ...
      <div class="col-md-9">
		  <?php
		  $status_dropdown = ["active" => lang("active"), "inactive" => lang("inactive")];
