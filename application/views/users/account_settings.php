<div class="tab-content">
	...
	echo form_open(get_uri($url . "/save_account_settings/" . $user_info->id), ["id" => "account-info-form", "class" => "general-form dashed-row white", "role" => "form"]);
	?>
   <div class="panel">
		  ...
		  <?php if($user_info->user_type === "staff" && $this->login_user->is_admin){ ?>
             <div class="form-group">
                ...
                <div class=" col-md-10">
					...
					{
						echo form_dropdown("role", $role_dropdown, [$user_info->role_id], "class='select2' id='user-role'");
						?>
                       <div id="user-role-help-block" class="help-block ml10 <?php echo $user_info->role_id === "admin" ? "" : "hide" ?>"><i
                                  class="fa fa-warning text-warning"></i> <?php echo lang("admin_user_has_all_power"); ?></div>
						<?php
					}
					?>
                </div>
		  ...
		  <?php if($this->login_user->is_admin && $user_info->id !== $this->login_user->id){ ?>
             <div class="form-group">
                ...
                <div class="col-md-10">
					...
					?>
                   <span id="disable-login-help-block" class="ml10 <?php echo $user_info->disable_login ? "" : "hide" ?>"><i
                              class="fa fa-warning text-warning"></i> <?php echo lang("disable_login_help_message"); ?></span>
                </div>
             </div>
			  ...
			  <?php if($user_info->user_type === "staff"){ ?>
                <div class="form-group">
                   ...
                   <div class="col-md-10">
					   ...
					   ?>
                      <span id="user-status-help-block" class="ml10 <?php echo $user_info->status === "inactive" ? "" : "hide" ?>"><i
                                 class="fa fa-warning text-warning"></i> <?php echo lang("mark_as_inactive_help_message"); ?></span>
                   </div>
                </div>
			  <?php } ?>
