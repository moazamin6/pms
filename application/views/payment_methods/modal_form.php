<?php echo form_open(get_uri("payment_methods/save"), ["id" => "payment-method-form", "class" => "general-form", "role" => "form"]); ?>
	...
	<?php if($model_info->online_payable == 1){ ?>
       ...
       <div class="form-group">
          <label for="minimum_payment_amount" class="col-md-4"><?php echo lang('minimum_payment_amount'); ?>
             <span class="help" data-toggle="tooltip" title="<?php echo lang('minimum_payment_amount_help_text'); ?>"><i
			...
			foreach($settings as $setting)
			{
               ...
               <div class="form-group">
                  <label for="<?php echo get_array_value($setting, "name"); ?>" class="col-md-4"><?php
					  ...
					  {
						  ?>
                         <span class="help" data-toggle="tooltip" title="<?php echo get_array_value($setting, "help_text"); ?>"><i
                                    class="fa fa-question-circle"></i></span>
					  <?php }
					  ?>
