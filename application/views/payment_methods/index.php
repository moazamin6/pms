         ...
         <div class="panel panel-default">
            <div class="page-title clearfix">
               ...
               <div class="title-button-group">
				   <?php echo modal_anchor(get_uri("payment_methods/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_payment_method'), ["class" => "btn btn-default", "title" => lang('add_payment_method')]); ?>
               </div>
            </div>
