   ...
   <div class="row">
      ...
      <div class="box">
         <div class="box-content message-button-list">
            <ul class="list-group ">
				<?php echo modal_anchor(get_uri("messages/modal_form"), lang('compose'), ["class" => "list-group-item", "title" => lang('send_message')]); ?>

				<?php echo anchor(get_uri("messages/inbox"), lang('inbox'), ["class" => "list-group-item"]); ?>

				<?php echo anchor(get_uri("messages/sent_items"), lang('sent_items'), ["class" => "list-group-item"]); ?>
            </ul>
         </div>
