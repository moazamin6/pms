...
<div id="js-single-user-chat-list" class="rise-chat-body full-height">
   ...
   <div class='clearfix p10 b-b'>
	   ...
	   {
		   echo modal_anchor(get_uri("messages/modal_form/" . $user_id), "<i class='fa fa-plus-circle'></i> " . lang("new_conversation"), ["class" => "btn btn-default col-md-12 col-sm-12 col-xs-12", "title" => lang('send_message')]);
	   }
	   ?>
   </div>
