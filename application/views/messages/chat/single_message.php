...
if($total_files)
{
	...
	$download_caption = anchor(get_uri("messages/download_message_files/" . $reply_info->id), "<i class='fa fa-paperclip pull-left font-16'></i>" . $download_lang, ["class" => "", "title" => $download_lang]);
}
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="chat-msg js-chat-msg" data-message_id="<?php echo $reply_info->id; ?>"><?php
				...
				if($download_caption)
				{
					$this->load->view("includes/timeline_preview", ["files" => $files, "is_message_row" => true]);
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="avatar-xs avatar mr10">
				...
				{
					echo get_client_contact_profile_link($reply_info->from_user_id, " <img alt='...' src='" . $avatar . "' /> ", ["class" => "dark strong"]);
				}
				else
				{
					echo get_team_member_profile_link($reply_info->from_user_id, " <img alt='...' src='" . $avatar . "' /> ", ["class" => "dark strong"]);
				}
				?>
            </div>
