   ...
   <div class="media b-b p15 m0 bg-white">
         ...
         <div class="col-md-12">
            ...
            <div class="media-body w100p">
               <div class="media-heading clearfix">
				   ...
				   {
					   echo get_client_contact_profile_link($message_user_id, $message_info->user_name, ["class" => "dark strong"]);
				   }
				   else
				   {
					   echo get_team_member_profile_link($message_user_id, $message_info->user_name, ["class" => "dark strong"]);
				   }
				   ?>
                  ...
                  <span class="pull-right dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li role="presentation"><?php echo ajax_anchor(get_uri("messages/delete_my_messages/$message_info->id"), "<i class='fa fa-times'></i> " . lang('delete'), ["class" => "", "title" => lang('delete'), "data-fade-out-on-success" => ".message-container-$message_info->id"]); ?> </li>
                            </ul>
                        </span>
               </div>
               ...
               <div class="comment-image-box clearfix">
				   ...
				   if($total_files)
				   {
					   ...
					   echo anchor(get_uri("messages/download_message_files/" . $message_info->id), $download_caption, ["class" => "pull-right", "title" => $download_caption]);
				   }
				   ?>
               </div>
	...
	if($found_rows > 5)
	{
       ...
       <div id="load-messages" class="b-b">
		   <?php
		   echo js_anchor(lang("load_more"), ["class" => "btn btn-default no-border w100p", "title" => lang("load_more"), "id" => "load-more-messages-link"]);
		   ?>
       </div>
	...
	{
		?>
		<?php $this->load->view("messages/reply_row", ["reply_info" => $reply_info]); ?>
	<?php } ?>

   <div id="reply-form-container">
      <div id="reply-form-dropzone" class="post-dropzone">
		  <?php echo form_open(get_uri("messages/reply"), ["id" => "message-reply-form", "class" => "general-form", "role" => "form"]); ?>
