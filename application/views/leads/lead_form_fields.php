...
<div class="form-group">
   ...
   <div class="<?php echo $field_column; ?>">
	   ...
	   echo form_dropdown("lead_status_id", $lead_status, [$model_info->lead_status_id], "class='select2'");
	   ?>
   </div>
</div>
<div class="form-group">
...
<div class="form-group">
   ...
   <div class="<?php echo $field_column; ?>">
	   ...
	   echo form_dropdown("lead_source_id", $lead_source, [$model_info->lead_source_id], "class='select2'");
	   ?>
   </div>
</div>
<div class="form-group">
