<div class="panel">
   <div class="tab-title clearfix">
      ...
      <div class="title-button-group">
		  <?php
		  echo modal_anchor(get_uri("leads/file_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_files'), ["class" => "btn btn-default", "title" => lang('add_files'), "data-post-client_id" => $client_id]);
		  ?>
      </div>
   </div>
