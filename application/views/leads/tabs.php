<li class="js-leads-cookie-tab <?php echo ($active_tab == 'leads_list') ? 'active' : ''; ?>" data-tab="leads_list"><a
           href="<?php echo_uri('leads'); ?>"><?php echo lang("list"); ?></a></li>
<li class="js-leads-cookie-tab <?php echo ($active_tab == 'leads_kanban') ? 'active' : ''; ?>" data-tab="leads_kanban"><a
           href="<?php echo_uri('leads/all_leads_kanban/'); ?>"><?php echo lang('kanban'); ?></a></li>
