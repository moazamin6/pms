...
<div class="custom-fields-on-migration" data-user-id="<?php echo $model_info->id; ?>">
	<?php $this->load->view("custom_fields/form/prepare_context_fields", ["custom_fields" => $custom_fields, "label_column" => $label_column, "field_column" => $field_column]); ?>
</div>
   ...
   <div class="form-group">
      ...
      <div class=" col-md-8">
         <div class="input-group">
			 ...
			 ?>
            <label for="password-<?php echo $model_info->id; ?>" class="input-group-addon clickable" id="generate_password-<?php echo $model_info->id; ?>"><span
                       class="fa fa-key"></span> <?php echo lang('generate'); ?></label>
         </div>
      </div>
      <div class="col-md-1 p0">
         <a href="#" id="show_hide_password-<?php echo $model_info->id; ?>" class="btn btn-default" title="<?php echo lang('show_text'); ?>"><span
...
<?php if($this->login_user->is_admin){ ?>
   <div class="form-group">
      <input type="hidden" class="is_primary_contact_value" name="is_primary_contact_value-<?php echo $model_info->id; ?>"
             value="<?php echo $model_info->is_primary_contact; ?>"/>
...
<?php $this->load->view("leads/custom_field_migration", ["custom_fields" => $custom_fields, "label_column" => $label_column, "field_column" => $field_column, "to_custom_field_type" => "client_contacts", "model_info" => $model_info]); ?>
