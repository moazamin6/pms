<div class="panel">
   <div class="tab-title clearfix">
      ...
      <div class="title-button-group">
		  <?php
		  echo modal_anchor(get_uri("leads/add_new_contact_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_contact'), ["class" => "btn btn-default", "title" => lang('add_contact'), "data-post-client_id" => $client_id]);
		  ?>
      </div>
   </div>
