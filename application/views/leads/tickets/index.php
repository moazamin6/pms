	   ...
	   <?php if(isset($page_type) && $page_type === "full"){ ?>
          <div class="page-title clearfix">
             ...
             <div class="title-button-group">
				 <?php echo modal_anchor(get_uri("tickets/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_ticket'), ["class" => "btn btn-default", "data-post-client_id" => $client_id, "title" => lang('add_ticket')]); ?>
             </div>
          </div>
	   <?php } else{ ?>
