<?php echo form_open(get_uri("leads/save_as_client"), ["id" => "make-client-form", "class" => "general-form", "role" => "form"]); ?>
	...
	<?php if($contacts){ ?>
       <div class="form-widget">
          ...
          <div class="progress ml15 mr15">
             <div id="form-progress-bar" class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0"
      ...
      <div role="tabpanel" class="tab-pane settings" id="lead-contacts-tab">
		  <?php foreach($contacts as $key => $value){ ?>
             ...
             <div class="lead-migration-contacts">
                <div class="clearfix settings-anchor m15 font-14 strong <?php echo $collapsed_class; ?>" data-toggle="collapse"
                     data-target="#contact-<?php echo $key; ?>">
                ...
                <div id='contact-<?php echo $key; ?>' class='pt15 b-t collapse <?php echo $collapse_in; ?>'>
					<?php $this->load->view("leads/contacts/contact_general_info_fields_for_migration", ["model_info" => $value, "custom_fields" => $value->custom_fields]); ?>
                </div>
             </div>
		  <?php } ?>
      </div>
...
<div class="modal-footer">
   <button class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> <?php echo lang('close'); ?></button>
	...
	<?php if($contacts){ ?>
       <button id="form-previous" type="button" class="btn btn-default hide"><span class="fa fa-arrow-circle-left"></span> <?php echo lang('previous'); ?>
       </button>
       <button id="form-next" type="button" class="btn btn-info"><span class="fa  fa-arrow-circle-right"></span> <?php echo lang('next'); ?></button>
	<?php } ?>

   <button id="form-submit" type="button" class="btn btn-primary <?php echo $contacts ? "hide" : ""; ?>"><span
