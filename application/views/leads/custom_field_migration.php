   ...
   <div class="form-group">
      ...
      <div class="<?php echo $field_column; ?> custom-field-migration-fields">
         <div class="pb10">
            ...
            <span class="help" data-container="body" data-toggle="tooltip"
                  title="<?php echo sprintf(lang('merge_custom_fields_help_message'), lang($to_custom_field_type), lang($to_custom_field_type)); ?>"><i
