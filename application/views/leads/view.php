<div class="page-title clearfix no-border bg-off-white">
   <h1>
	...
	<?php echo modal_anchor(get_uri("leads/make_client_modal_form/") . $lead_info->id, "<i class='fa fa-briefcase'></i> " . lang('make_client'), ["class" => "btn btn-primary pull-right mr15", "title" => lang('make_client')]); ?>
</div>

<div id="page-content" class="clearfix">
   <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
      <li><a role="presentation" href="<?php echo_uri("leads/contacts/" . $lead_info->id); ?>" data-target="#lead-contacts"> <?php echo lang('contacts'); ?></a>
      </li>
      ...
      <li><a role="presentation" href="<?php echo_uri("leads/files/" . $lead_info->id); ?>" data-target="#lead-files"><?php echo lang('files'); ?></a></li>
	   ...
	   <?php if($show_event_info){ ?>
          <li><a role="presentation" href="<?php echo_uri("leads/events/" . $lead_info->id); ?>" data-target="#lead-events"> <?php echo lang('events'); ?></a>
          </li>
	   <?php } ?>
   </ul>
