<div id="page-content" class="p20 pb0 clearfix">
   ...
   <ul class="nav nav-tabs bg-white title" role="tablist">
      <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo lang("leads"); ?></h4></li>
	   ...
	   <?php $this->load->view("leads/tabs", ["active_tab" => "leads_kanban"]); ?>

      <div class="tab-title clearfix no-border">
         <div class="title-button-group">
			 <?php echo modal_anchor(get_uri("leads/import_leads_modal_form"), "<i class='fa fa-upload'></i> " . lang('import_leads'), ["class" => "btn btn-default", "title" => lang('import_leads')]); ?>
			 <?php echo modal_anchor(get_uri("leads/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_lead'), ["class" => "btn btn-default", "title" => lang('add_lead')]); ?>
         </div>
      </div>
   </ul>
