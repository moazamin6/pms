<?php echo form_open(get_uri("leads/save_lead_from_excel_file"), ["id" => "import-lead-form", "class" => "general-form", "role" => "form"]); ?>
...
<div class="modal-footer">
	<?php echo anchor("leads/download_sample_excel_file", "<i class='fa fa-cloud-download'></i> " . lang("download_sample_file"), ["title" => lang("download_sample_file"), "class" => "btn btn-default pull-left"]); ?>
