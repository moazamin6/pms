<?php echo form_open(get_uri("estimates/send_estimate"), ["id" => "send-estimate-form", "class" => "general-form", "role" => "form"]); ?>
<div class="modal-body clearfix">
   ...
   <div class="form-group ml15">
      <i class='fa fa-check-circle'
         style="color: #5CB85C;"></i> <?php echo lang('attached') . ' ' . anchor(get_uri("estimates/download_pdf/" . $estimate_info->id), lang("estimate") . "-$estimate_info->id.pdf", ["target" => "_blank"]); ?>
   </div>
