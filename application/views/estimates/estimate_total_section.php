<table id="estimate-item-table" class="table display dataTable text-right strong table-responsive">
   <tr>
	...
	$discount_row = "<tr>
                        ...
                        <td class='text-center option w100'>" . modal_anchor(get_uri("estimates/discount_modal_form"), "<i class='fa fa-pencil'></i>", ["class" => "edit", "data-post-estimate_id" => $estimate_id, "title" => lang('edit_discount')]) . "<span class='p20'>&nbsp;&nbsp;&nbsp;</span></td>
                    </tr>";
