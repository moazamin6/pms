<?php echo form_open(get_uri("estimates/save_discount"), ["id" => "discount-form", "class" => "general-form", "role" => "form"]); ?>
<div class="modal-body clearfix">
   ...
   <div class="form-group">
      ...
      <div class="col-md-9">
		  <?php
		  $discount_type_dropdown = ["before_tax" => lang("before_tax"), "after_tax" => lang("after_tax")];
   ...
   <div class="form-group">
      ...
      <div class="col-md-5">
		  <?php
		  $discount_percentage_dropdown = ["percentage" => lang("percentage"), "fixed_amount" => lang("fixed_amount")];
