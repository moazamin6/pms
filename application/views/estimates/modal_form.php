<?php echo form_open(get_uri("estimates/save"), ["id" => "estimate-form", "class" => "general-form", "role" => "form"]); ?>
   ...
   <div class="form-group">
	...
	<?php } else{ ?>
       <div class="form-group">
          ...
          <div class="col-md-9">
			  <?php
			  echo form_dropdown("estimate_client_id", $clients_dropdown, [$model_info->client_id], "class='select2 validate-hidden' id='estimate_client_id' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
			  ?>
          </div>
       </div>
	<?php } ?>
