<li class="hidden-xs">
	<?php echo ajax_anchor(get_uri("dashboard/show_my_dashboards/"), "<i class='fa fa-desktop'></i>", ["class" => "dropdown-toggle", "data-toggle" => "dropdown", "data-real-target" => "#my-dashboards-list-container"]); ?>
