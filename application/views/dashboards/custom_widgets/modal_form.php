<?php echo form_open(get_uri("dashboard/save_custom_widget"), ["id" => "custom_widget-form", "class" => "general-form", "role" => "form"]); ?>
...
<div class="modal-footer">
   <div id="link-of-widget-view" class="hide">
	   <?php
	   echo modal_anchor(get_uri("dashboard/view_custom_widget"), "", []);
	   ?>
   </div>
   <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> <?php echo lang('close'); ?></button>
   <button id="save-and-show-widget-button" type="button" class="btn btn-info"><span class="fa fa-check-circle"></span> <?php echo lang('save_and_show'); ?>
   </button>
