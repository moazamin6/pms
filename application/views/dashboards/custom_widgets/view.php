<?php load_js(["assets/js/bootstrap-confirmation/bootstrap-confirmation.js"]); ?>
...
<div class="modal-footer">
	<?php
	echo js_anchor("<i class='fa fa-times-circle-o'></i> " . lang('delete_widget'), ["class" => "btn btn-default pull-left", "id" => "delete_widget"]);

	echo modal_anchor(get_uri("dashboard/custom_widget_modal_form/" . $model_info->id), "<i class='fa fa-pencil'></i> " . lang('edit_widget'), ["class" => "btn btn-default", "title" => lang('edit_widget')]);
	?>
