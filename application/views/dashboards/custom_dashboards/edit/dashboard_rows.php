...
<div id="add-column-button" class="dropdown-toggle w100p p10 bg-white text-center clickable" data-toggle="collapse" data-target="#add-column-collapse-panel"><i
           class="fa fa-plus-circle"></i> <?php echo lang("add_row"); ?></div>
   ...
   <div class="panel mb0">
      <div class="list-group text-center">
		  ...
		  foreach($columns_array as $key => $value)
		  {
			  ...
			  echo js_anchor($content, ["class" => "p10 text-center list-group-item column-grid-link", "data-column-value" => $key]);
		  }
		  ?>
