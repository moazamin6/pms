<?php echo form_open(get_uri("events/save_google_calendar_settings"), ["id" => "google-calendar-settings-form", "class" => "general-form", "role" => "form"]); ?>
<div class="modal-body clearfix post-dropzone">
   ...
   <div class="clearfix integrate-with-google-calendar-details-section <?php echo $integrate_with_google_calendar ? "" : "hide" ?>">
      ...
      <div class="form-group">
         <label for="redirect_uri" class=" col-md-3"><i
      ...
      <div class="form-group mb15">
         ...
         <div class="col-md-9">
            ...
            <div class="calendar-ids-field">
					...
					foreach($calendar_ids as $calendar_id)
					{
                       ...
                       <div class="calendar-ids-form clearfix pb10">
                          <div class="col-md-10 p0">
						   ...
						   <?php echo js_anchor("<i class='fa fa-times'></i> ", ["class" => "remove-calendar-id delete-post-dropzone ml10"]); ?>
                       </div>
						<?php
					}
				}
			 ...
			 <?php echo js_anchor("<i class='fa fa-plus-circle'></i> " . lang('add_more'), ["class" => "add-calendar-id", "id" => "add-more-calendar-id"]); ?>
         </div>
      </div>
...
<div class="modal-footer">
   ...
   <button id="save-button" type="submit" class="btn btn-primary <?php echo $integrate_with_google_calendar ? "hide" : "" ?>"><span
              class="fa fa-check-circle"></span> <?php echo lang('save'); ?></button>
   <button id="save-and-authorize-button" type="submit" class="btn btn-primary ml5 <?php echo $integrate_with_google_calendar ? "" : "hide" ?>"><span
