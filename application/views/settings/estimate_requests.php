<?php echo form_open(get_uri("settings/save_estimate_request_settings"), ["id" => "estimate-requests-settings-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
<div class="panel">

   <div class="panel-body">
      <div class="form-group">
         <label for="hidden_client_fields_on_public_estimate_requests"
                class=" col-md-2"><?php echo lang('hidden_client_fields_on_public_estimate_requests'); ?></label>
         <div class=" col-md-9">
			 <?php
			 echo form_input([
			 ...
			 ?>
            <span id="name_and_email_error_message" class="mt10 inline-block hide"><i
                       class="fa fa-warning text-warning"></i> <?php echo lang("estimate_request_name_email_error_message"); ?></span>
         </div>
      </div>
   </div>
