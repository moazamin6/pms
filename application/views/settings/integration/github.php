<div class="panel panel-default no-border clearfix mb0">
	...
	<?php echo form_open(get_uri("settings/save_github_settings"), ["id" => "github-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
      ...
      <div class="github-details-area <?php echo get_setting("enable_github_commit_logs_in_tasks") ? "" : "hide" ?>">
         <div class="form-group">
            <label for="" class=" col-md-12">
				<?php echo lang("add_webhook_in_your_repository_at") . " " . anchor("https://github.com/", "GitHub", ["target" => "_blank"]); ?>
            </label>
         </div>
         ...
         <div class="form-group clearfix">
            ...
            <div class=" col-md-9">
               ...
               <span id="webhook_listener_link_of_github"><?php echo get_uri("webhooks_listener/github") . "/" . get_setting("enable_github_commit_logs_in_tasks"); ?></span><span
                       id="reset-key-github" class="fa fa-refresh p10 ml15 clickable"></span>
            </div>
         </div>
