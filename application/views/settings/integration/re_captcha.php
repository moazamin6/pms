<div class="panel panel-default no-border clearfix mb0">
	...
	<?php echo form_open(get_uri("settings/save_re_captcha_settings"), ["id" => "re-captcha-form", "class" => "general-form dashed-row", "role" => "form"]); ?>

   <div class="panel-body">

      <div class="form-group">
         <label class=" col-md-12">
			 <?php echo lang("get_your_key_from_here") . " " . anchor("https://www.google.com/recaptcha/admin", "Google reCAPTCHA", ["target" => "_blank"]); ?>
         </label>
      </div>
      ...
      <div class="form-group">
         <div class="col-md-12">
            ...
            <span><?php echo lang("re_captcha_info_text"); ?></span>
         </div>
      </div>
