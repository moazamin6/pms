<div class="panel panel-default no-border clearfix mb0">
	<?php echo form_open(get_uri("settings/save_google_drive_settings"), ["id" => "google-drive-form", "class" => "general-form dashed-row", "role" => "form"]); ?>

   <div class="panel-body">

      <div class="form-group">
         <label for="enable_google_drive_api_to_upload_file"
                class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('enable_google_drive_api_to_upload_file'); ?></label>
         <div class="col-md-10 col-xs-4 col-sm-8">
			 ...
			 ?>
            <span class="google-drive-show-hide-area ml10 <?php echo get_setting("enable_google_drive_api_to_upload_file") ? "" : "hide" ?>"><i
                       class="fa fa-warning text-warning"></i> <?php echo lang("drive_activation_help_message"); ?></span>
         </div>
      </div>
      ...
      <div class="google-drive-show-hide-area <?php echo get_setting("enable_google_drive_api_to_upload_file") ? "" : "hide" ?>">
         ...
         <div class="form-group">
            <label class=" col-md-12">
				<?php echo lang("get_your_app_credentials_from_here") . " " . anchor("https://console.developers.google.com", "Google API Console", ["target" => "_blank"]); ?>
            </label>
         </div>
         ...
         <div class="form-group">
            <label for="redirect_uri" class=" col-md-2"><i
                       class="fa fa-warning text-warning"></i> <?php echo lang('remember_to_add_this_url_in_authorized_redirect_uri'); ?></label>
            <div class=" col-md-10">
				<?php
   ...
   <div class="panel-footer">
      <button id="save-button" type="submit" class="btn btn-primary <?php echo get_setting("enable_google_drive_api_to_upload_file") ? "hide" : "" ?>"><span
                 class="fa fa-check-circle"></span> <?php echo lang('save'); ?></button>
      <button id="save-and-authorize-button" type="submit"
              class="btn btn-primary ml5 <?php echo get_setting("enable_google_drive_api_to_upload_file") ? "" : "hide" ?>"><span
                 class="fa fa-check-circle"></span> <?php echo lang('save_and_authorize'); ?></button>
   </div>
	<?php echo form_close(); ?>
</div>
