      ...
      <div class="col-sm-9 col-lg-10">
         ...
         <div class="panel panel-default no-border clearfix ">
            ...
            <ul id="integration-tab" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
               ...
               <li><a role="presentation" class="active" href="<?php echo_uri("settings/re_captcha/"); ?>" data-target="#integration-re-captcha">reCAPTCHA</a>
               </li>
               <li><a id="google_drive" role="presentation" href="<?php echo_uri("settings/google_drive/"); ?>" data-target="#integration-google-drive">Google
                     Drive</a></li>
               <li><a role="presentation" class="" href="<?php echo_uri("settings/push_notification/"); ?>"
                      data-target="#integration-push-notification"><?php echo lang("pusher"); ?></a></li>
