<div id="page-content" class="p20 clearfix">
   <div class="row">
      ...
      <div class="col-sm-9 col-lg-10">
		  <?php echo form_open(get_uri("settings/save_module_settings"), ["id" => "module-settings-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
         <div class="panel">
            ...
            <div class="panel-body">
               ...
               <div class="form-group">
                  <label for="module_knowledge_base"
                         class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('knowledge_base') . " (" . lang("public") . ")"; ?></label>
                  <div class="col-md-10 col-xs-4 col-sm-8">
					  <?php
