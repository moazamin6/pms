<div id="page-content" class="p20 clearfix">
   <div class="row">
      ...
      <div class="col-sm-9 col-lg-10">
		  <?php echo form_open(get_uri("settings/save_event_settings"), ["id" => "event-settings-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
         <div class="panel">
            ...
            <div class="panel-body">
               <div class="form-group">
                  <label for="enable_google_calendar_api" class=" col-md-3"><?php echo lang('enable_google_calendar_api'); ?> <span class="help"
                                                                                                                                    data-toggle="tooltip"
                  ...
                  <div class="col-md-9">
					  ...
					  ?>
                     <span class="google-calendar-show-hide-text ml10 <?php echo get_setting("enable_google_calendar_api") ? "" : "hide" ?>"><i
                                class="fa fa-warning text-warning"></i> <?php echo lang("now_every_user_can_integrate_with_their_google_calendar"); ?></span>
                  </div>
               </div>
            </div>
