         ...
         <div class="panel panel-default">
            <div class="page-title clearfix">
               ...
               <div class="title-button-group">
                  <button id="restore_to_default" data-toggle="popover" data-placement="bottom" type="button" class="btn btn-danger"><span
                             class="fa fa-refresh"></span> <?php echo lang('restore_to_default'); ?></button>
				   <?php echo anchor(get_uri("dashboard/edit_client_default_dashboard"), "<i class='fa fa-columns'></i> " . lang('edit_dashboard'), ["class" => "btn btn-default", "title" => lang('edit_dashboard')]); ?>
               </div>
            </div>
