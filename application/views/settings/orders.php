<div id="page-content" class="p20 clearfix">
   <div class="row">
      ...
      <div class="col-sm-9 col-lg-10">
		  <?php echo form_open(get_uri("settings/save_order_settings"), ["id" => "order-settings-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
         <div class="panel panel-default">
            ...
            <ul data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
               ...
               <li><a role="presentation" href="<?php echo_uri("order_status"); ?>"
                      data-target="#order-status-settings-tab"><?php echo lang('order_status'); ?></a></li>
               <div class="tab-title clearfix no-border">
                  <div class="title-button-group">
					  <?php echo modal_anchor(get_uri("order_status/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_order_status'), ["class" => "btn btn-default hide", "title" => lang('add_order_status'), "id" => "order-status-add-btn"]); ?>
                  </div>
               </div>
            </ul>
               ...
               <div role="tabpanel" class="tab-pane fade" id="order-settings-tab">
                  <div class="panel-body">
                     <div class="form-group">
                        ...
                        <div class=" col-md-10">
                           ...
                           <div class="pull-left file-upload btn btn-default btn-xs">
                              ...
                              <input id="order_logo_file" class="cropbox-upload upload" name="order_logo_file" type="file" data-height="100" data-width="300"
                                     data-preview-container="#order-logo-preview" data-input-field="#order_logo"/>
                           </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-10">
							<?php
							echo form_dropdown("order_tax_id", $taxes_dropdown, [get_setting('order_tax_id')], "class='select2 tax-select2 mini'");
							?>
                        </div>
                     </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-10">
							<?php
							echo form_dropdown("order_tax_id2", $taxes_dropdown, [get_setting('order_tax_id2')], "class='select2 tax-select2 mini'");
							?>
                        </div>
                     </div>
                     <div class="form-group">
