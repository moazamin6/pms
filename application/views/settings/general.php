<div id="page-content" class="p20 clearfix">
   <div class="row">
      ...
      <div class="col-sm-9 col-lg-10">
		  <?php echo form_open(get_uri("settings/save_general_settings"), ["id" => "general-settings-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
         <div class="panel">
            ...
            <div class="panel-body post-dropzone">
               <div class="form-group">
                  ...
                  <div class=" col-md-10">
                     ...
                     <div class="pull-left file-upload btn btn-default btn-xs">
                        ...
                        <input id="site_logo_file" class="cropbox-upload upload" name="site_logo_file" type="file" data-height="40" data-width="175"
                               data-preview-container="#site-logo-preview" data-input-field="#site_logo"/>
                     </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-lg-10">
                     ...
                     <div class="pull-left file-upload btn btn-default btn-xs">
                        <i class="fa fa-upload"></i> <?php echo lang("upload_and_crop"); ?>
                        <input id="favicon_file" class="cropbox-upload upload" name="favicon_file" type="file" data-height="32" data-width="32"
                               data-preview-container="#favicon-preview" data-input-field="#favicon"/>
                     </div>
                     <div class="mt10 ml10 pull-left">
						 <?php
						 echo form_upload([
               ...
               <div class="form-group">
                  ...
                  <div class=" col-md-10">
                     <div class="pull-left mr15">
                        <img id="signin-background-preview" style="max-width: 100px; max-height: 80px;"
                             src="<?php echo get_file_from_setting("signin_page_background"); ?>" alt="..."/>
                     </div>
                     <div class="pull-left mr15">
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-10">
					  <?php
					  $days_dropdown = [
						  ["id" => "0", "text" => lang("sunday")],
						  ["id" => "1", "text" => lang("monday")],
						  ["id" => "2", "text" => lang("tuesday")],
						  ["id" => "3", "text" => lang("wednesday")],
						  ["id" => "4", "text" => lang("thursday")],
						  ["id" => "5", "text" => lang("friday")],
						  ["id" => "6", "text" => lang("saturday")],
					  ];
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-10">
					  <?php
					  echo form_dropdown(
						  "decimal_separator", ["." => "Dot (.)", "," => "Comma (,)"], get_setting('decimal_separator'), "class='select2 mini'"
					  );
					  ?>
                  </div>
               </div>
