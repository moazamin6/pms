<?php echo form_open(get_uri("settings/save_imap_settings"), ["id" => "imap-settings-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
...
<div class="panel">
	...
	<?php if($php_version_success && $imap_extension_success){ ?>
          ...
          <div class="form-group">
             <div class="col-md-12">
                <i class="fa fa-info-circle"></i> <?php echo lang("imap_help_message_1"); ?> <br/>
				 <?php echo lang("imap_help_message_2") . " " . anchor(get_uri("email_templates"), ucfirst(lang("email_templates")) . " " . strtolower(lang("settings")), ["target" => "_blank"]) . "."; ?>
             </div>
          </div>
          <div class="form-group">
          ...
          <div id="imap-details" class="<?php echo get_setting("enable_email_piping") ? "" : "hide"; ?>">
             ...
             <div class="form-group">
                ...
                <div class=" col-md-9">
					<?php
					echo form_dropdown(
						"imap_ssl_enabled", ["1" => lang("yes"), "0" => lang("no")], get_setting('imap_ssl_enabled'), "class='select2 mini'"
					);
					?>
                </div>
             </div>
             ...
             <div class="form-group">
                ...
                <div class=" col-md-9">
					...
					<?php if(get_setting("imap_failed_login_attempts_count")){ ?>
                       <span class="ml5 label"
                             style="background:#F9A52D;"><?php echo get_setting("imap_failed_login_attempts_count") . " " . lang("login_attempt_failed"); ?></span>
					<?php } ?>
                </div>
             </div>
          </div>
       ...
       <div class="panel-footer">
          <button id="save-button" type="submit" class="btn btn-primary <?php echo get_setting("enable_email_piping") ? "hide" : "" ?>"><span
                     class="fa fa-check-circle"></span> <?php echo lang('save'); ?></button>
          <button id="save-and-authorize-button" type="submit" class="btn btn-primary ml5 <?php echo get_setting("enable_email_piping") ? "" : "hide" ?>"><span
