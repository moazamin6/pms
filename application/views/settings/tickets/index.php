<?php echo form_open(get_uri("settings/save_ticket_settings"), ["id" => "ticket-settings-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
<div class="panel">

   <div class="panel-body">
      <div class="form-group">
         <label for="show_recent_ticket_comments_at_the_top"
                class="col-md-4 col-xs-8 col-sm-4"><?php echo lang('show_most_recent_ticket_comments_at_the_top'); ?></label>
      ...
      <div class="form-group">
         <label for="auto_close_ticket_after" class="col-md-4"><?php echo lang('auto_close_ticket_after'); ?> <span class="help" data-toggle="tooltip"
      ...
      <div class="form-group">
         ...
         <div class="col-md-8">
            ...
            <span class="ml10 <?php echo get_setting('enable_embedded_form_to_get_tickets') ? "" : "hide"; ?>" id="external_form_embedded_url">
                    <?php echo modal_anchor(get_uri("external_tickets/embedded_code_modal_form"), "<i class='fa fa-code'></i>", ["title" => lang('embed'), "class" => "edit external-tickets-embedded-code"]) ?>
                </span>
         </div>
      </div>
