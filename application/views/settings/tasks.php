    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <?php
                echo form_dropdown(
                        "enable_recurring_option_for_tasks", array("1" => lang("yes"), "0" => lang("no")), get_setting('enable_recurring_option_for_tasks') ? get_setting('enable_recurring_option_for_tasks') : 0, "class='select2 mini' id='enable_recurring_option_for_tasks'"
                );
                ?>                     
            </div>
        </div>
        ...
        <div id="create_recurring_tasks_before_area" class="form-group <?php echo get_setting("enable_recurring_option_for_tasks") ? "" : "hide"; ?>">
            <label for="create_recurring_tasks_before" class=" col-md-3"><?php echo lang('create_recurring_tasks_before'); ?> <span class="help" data-toggle="tooltip" data-placement="left" title="<?php echo lang('cron_job_required'); ?>"><i class="fa fa-question-circle"></i></span></label>
            <div class="col-md-9">
                <?php
                echo form_dropdown(
