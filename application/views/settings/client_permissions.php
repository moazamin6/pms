      ...
      <div class="col-sm-9 col-lg-10">
         <div class="panel panel-default">
            <div class="page-title clearfix">
			 ...
			 <?php echo form_open(get_uri("settings/save_client_settings"), ["id" => "client-settings-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
            <div class="panel-body">
               ...
               <div class="form-group">
                  <label for="client_can_delete_own_files_in_project"
                         class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('client_can_delete_own_files_in_project'); ?></label>
                  <div class="col-md-10 col-xs-4 col-sm-8">
					  <?php
               ...
               <div class="form-group">
                  <label for="client_can_view_files" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('client_can_view_files'); ?> <span class="help"
                                                                                                                                           data-toggle="tooltip"
                                                                                                                                           title="<?php echo lang('client_access_files_help_message'); ?>"><i
               ...
               <div class="form-group">
                  <label for="client_can_add_files" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('client_can_add_files'); ?> <span class="help"
                                                                                                                                         data-toggle="tooltip"
                                                                                                                                         title="<?php echo lang('client_access_files_help_message'); ?>"><i
                                class="fa fa-question-circle"></i></span></label>
                  <div class="col-md-10 col-xs-4 col-sm-8">
               ...
               <div class="form-group">
                  <label for="disable_user_invitation_option_by_clients"
                         class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('disable_user_invitation_option_by_clients'); ?></label>
                  <div class="col-md-10 col-xs-4 col-sm-8">
					  <?php
               ...
               <div class="form-group">
                  <label for="client_can_access_store" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('client_can_access_store'); ?></label>
                  <div class="col-md-10 col-xs-4 col-sm-8">
					  <?php
					  echo form_checkbox("client_can_access_store", "1", get_setting("client_can_access_store") ? true : false, "id='client_can_access_store' class='ml15'");
					  ?>
                  </div>
               </div>

               <div class="form-group">
                  <label for="disable_access_favorite_project_option_for_clients"
                         class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('disable_access_favorite_project_option_for_clients'); ?></label>
                  <div class="col-md-10 col-xs-4 col-sm-8">
					  <?php
               ...
               <div class="form-group">
                  <label for="disable_editing_left_menu_by_clients"
                         class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('disable_editing_left_menu_by_clients'); ?></label>
                  <div class="col-md-10 col-xs-4 col-sm-8">
					  <?php
               ...
               <div class="form-group">
                  <label for="disable_topbar_menu_customization"
                         class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('disable_topbar_menu_customization'); ?></label>
                  <div class="col-md-10 col-xs-4 col-sm-8">
					  <?php
               ...
               <div class="form-group">
                  <label for="disable_dashboard_customization_by_clients"
                         class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('disable_dashboard_customization_by_clients'); ?></label>
                  <div class="col-md-10 col-xs-4 col-sm-8">
					  <?php
