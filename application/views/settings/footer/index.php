<div id="page-content" class="p20 clearfix">
   <div class="row">
      ...
      <div class="col-sm-9 col-lg-10">
		  <?php echo form_open(get_uri("settings/save_footer_settings"), ["id" => "footer-settings-form", "class" => "general-form dashed-row", "role" => "form"]); ?>
         <div class="panel">
                     ...
                     <div class="col-md-10">
                        ...
                        <div class="row">
                           ...
                           <div id="footer-menus-options-area" class="col-md-12 mt15 hide">
                              <button id="footer-menus-add-button" type="button" class="btn btn-primary"><span
                                         class="fa fa-check-circle"></span> <?php echo lang('add'); ?></button>
                              <button id="footer-menus-close-button" type="button" class="btn btn-default"><span
