<div class="panel panel-default">
   <div class='panel-heading'>
	...
	<?php echo form_open(get_uri("email_templates/save"), ["id" => "email-template-form", "class" => "general-form", "role" => "form"]); ?>
   <div class="modal-body clearfix">
      ...
      <div class="form-group m0">
         ...
         <button id="restore_to_default" data-toggle="popover" data-id="<?php echo $model_info->id; ?>" data-placement="top" type="button"
                 class="btn btn-danger"><span class="fa fa-refresh"></span> <?php echo lang('restore_to_default'); ?></button>
      </div>
