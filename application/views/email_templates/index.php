               ...
               <div id="template-list-box" class="panel panel-default">
                  ...
                  <ul class="nav nav-tabs vertical settings p15" role="tablist">
					  ...
					  foreach($templates as $template => $value)
					  {
						  ...
						  ?>
                         <div class="clearfix settings-anchor <?php echo $collapsed_class; ?>" data-toggle="collapse"
                              data-target="#settings-tab-<?php echo $template; ?>">
						  ...
						  {
							  echo "<span class='email-template-row list-group-item clickable' data-name='$sub_template_name'>" . lang($sub_template_name) . "</span>";
						  }
