<div class="box">
   <div class="box-content">
      <div id="timeline-content" class="clearfix p15 mb20">
		  ...
		  <?php timeline_widget(["limit" => 20, "offset" => 0, "is_first_load" => true]); ?>
      </div>
   </div>
                    ...
                    <div class="media">
                       ...
                       <div class="media-body clearfix w100p">
                          <div class="media-heading pull-left m0">
                             <div class="w150"><?php echo get_team_member_profile_link($member->id, $member->first_name . " " . $member->last_name, ["class" => "dark"]); ?></div>
                          ...
                          <div class="pull-right">
							  ...
							  {
								  echo modal_anchor(get_uri("messages/modal_form/" . $member->id), "<i class='fa fa-envelope-o'></i>", ["class" => "btn btn-default btn-xs round", "title" => lang('send_message')]);
							  }
							  ?>
                          </div>
                       </div>
