   ...
   <div id="reply-content-container-<?php echo $reply->id; ?>" class="media mb15 b-l reply-container">
      ...
      <div class="media-body">
         <div class="media-heading">
			 <?php echo get_team_member_profile_link($reply->created_by, $reply->created_by_user, ["class" => "dark strong"]); ?>
			 ...
			 <?php if($this->login_user->is_admin || $reply->created_by == $this->login_user->id){ ?>
                <span class="pull-right dropdown reply-dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation"><?php echo ajax_anchor(get_uri("timeline/delete/$reply->id"), "<i class='fa fa-times'></i> " . lang('delete'), ["class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#reply-content-container-$reply->id"]); ?> </li>
                        </ul>
                    </span>
			 <?php } ?>
         </div>
