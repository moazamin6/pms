<?php echo form_open(get_uri("invoice_payments/save_payment"), ["id" => "invoice-payment-form", "class" => "general-form", "role" => "form"]); ?>
<div class="modal-body clearfix">
   ...
   <div class="form-group">
      ...
      <div class="col-md-9">
		  <?php
		  echo form_dropdown("invoice_payment_method_id", $payment_methods_dropdown, [$model_info->payment_method_id], "class='select2'");
		  ?>
      </div>
   </div>
   <div class="form-group">
