<?php echo form_open(get_uri("invoices/save"), ["id" => "invoice-form", "class" => "general-form", "role" => "form"]); ?>
<div id="invoices-dropzone" class="post-dropzone">
   <div class="modal-body clearfix">
      ...
      <div class="form-group">
	   ...
	   <?php } else{ ?>
          <div class="form-group">
             ...
             <div class="col-md-9">
				 <?php
				 echo form_dropdown("invoice_client_id", $clients_dropdown, [$model_info->client_id], "class='select2 validate-hidden' id='invoice_client_id' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
				 ?>
             </div>
          </div>
	   <?php } ?>
      ...
      <div class="form-group">
         ...
         <div class="col-md-9">
			 <?php
			 echo form_dropdown("tax_id", $taxes_dropdown, [$model_info->tax_id], "class='select2 tax-select2'");
			 ?>
         </div>
      </div>
      <div class="form-group">
         ...
         <div class="col-md-9">
			 <?php
			 echo form_dropdown("tax_id2", $taxes_dropdown, [$model_info->tax_id2], "class='select2 tax-select2'");
			 ?>
         </div>
      </div>
      <div class="form-group">
         ...
         <div class="col-md-9">
			 <?php
			 echo form_dropdown("tax_id3", $taxes_dropdown, [$model_info->tax_id3], "class='select2 tax-select2'");
			 ?>
         </div>
      </div>
      <div class="form-group">
         <label for="invoice_recurring" class=" col-md-3"><?php echo lang('recurring'); ?> <span class="help" data-toggle="tooltip"
      ...
      <div class="form-group">
         <div class="col-md-12">
			 <?php
			 $this->load->view("includes/file_list", ["files" => $model_info->files]);
			 ?>
         </div>
      </div>
