<?php echo form_open(get_uri("invoices/save_item"), ["id" => "invoice-item-form", "class" => "general-form", "role" => "form"]); ?>
<div class="modal-body clearfix">
   ...
   <div class="form-group">
      ...
      <div class="col-md-9">
		  ...
		  ?>
         <a id="invoice_item_title_dropdwon_icon" tabindex="-1" href="javascript:void(0);"
