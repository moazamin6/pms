<table id="invoice-item-table" class="table display dataTable text-right strong table-responsive">
   <tr>
	...
	{
		$discount_edit_btn = "<td class='text-center option w100'>" . modal_anchor(get_uri("invoices/discount_modal_form"), "<i class='fa fa-pencil'></i>", ["class" => "edit", "data-post-invoice_id" => $invoice_id, "title" => lang('edit_discount')]) . "<span class='p20'>&nbsp;&nbsp;&nbsp;</span></td>";
	}
	$discount_row = "<tr>
