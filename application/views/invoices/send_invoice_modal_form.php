<?php echo form_open(get_uri("invoices/send_invoice"), ["id" => "send-invoice-form", "class" => "general-form", "role" => "form"]); ?>
<div id="send_invoice-dropzone" class="post-dropzone">
   <div class="modal-body clearfix">
      ...
      <div class="form-group">
         ...
         <div class=" col-md-9">
			 <?php
			 echo form_dropdown("contact_id", $contacts_dropdown, [], "class='select2 validate-hidden' id='contact_id' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
			 ?>
         </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group ml15">
         <i class='fa fa-check-circle'
            style="color: #5CB85C;"></i> <?php echo lang('attached') . ' ' . anchor(get_uri("invoices/download_pdf/" . $invoice_info->id), lang("invoice") . "-$invoice_info->id.pdf", ["target" => "_blank"]); ?>
      </div>
   ...
   <div class="modal-footer">
      <button class="btn btn-default upload-file-button pull-left btn-sm round" type="button" style="color:#7988a2"><i
                 class="fa fa-camera"></i> <?php echo lang("add_attachment"); ?></button>
