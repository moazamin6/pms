<?php echo form_open($paypal_url, ["id" => "paypal-payments-standard-checkout-form", "class" => "pull-left", "role" => "form"]); ?>
...
<input name="custom"
       value="invoice_id:<?php echo $invoice_info->id; ?>;contact_user_id:<?php echo isset($contact_user_id) ? $contact_user_id : $this->login_user->id; ?>;client_id:<?php echo $invoice_info->client_id; ?>;payment_method_id:<?php echo get_array_value($payment_method, "id"); ?>"
       type="hidden"/>
