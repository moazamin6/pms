<div id="page-content" class="p20 clearfix">
   ...
   <div class="invoice-preview">
          ...
          <div class="panel panel-default  p15 no-border clearfix">
             ...
             <div class="mr15 strong pull-left general-form pull-left" style="width: 145px;">
				 <?php if(get_setting("allow_partial_invoice_payment_from_clients")){ ?>
                    <span style="background-color: #f6f8f9; display: inline-block; padding: 7px 2px 7px 10px;"><?php echo $invoice_total_summary->currency; ?></span>
                    <input type="text" id="payment-amount" value="<?php echo to_decimal_format($invoice_total_summary->balance_due); ?>"
                           class="form-control inline-block" style="padding-left: 3px; width: 100px"/>
				 <?php } else{ ?>
             ...
             <div class="pull-right">
				 <?php
				 echo "<div class='text-center'>" . anchor("invoices/download_pdf/" . $invoice_info->id, lang("download_pdf"), ["class" => "btn btn-default round"]) . "</div>"
				 ?>
             </div>
	   ...
	   {
		   echo "<div class='text-center'>" . anchor("invoices/view/" . $invoice_info->id, lang("close_preview"), ["class" => "btn btn-default round"]) . "</div>";
	   }
	   ?>
