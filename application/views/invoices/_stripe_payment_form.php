...
echo form_open("", ["id" => "stripe-checkout-form", "class" => "pull-left", "role" => "form"]);
?>
...
<input type="hidden" name="description" value="<?php echo lang("pay_invoice"); ?>: (<?php echo to_currency($balance_due, $currency . " "); ?>)"
       id="description"/>
