                ...
                <span class="pull-right dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
							...
							echo js_anchor($default_currency, ["class" => "load-currency-wise-data", "data-value" => $default_currency]); //default currency

							foreach($currencies as $currency)
							{
								echo js_anchor($currency->currency, ["class" => "load-currency-wise-data", "data-value" => $currency->currency]);
							}
							?>
                        </li>
                    </ul>
