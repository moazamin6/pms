<div id="page-content" class="p20 clearfix">
	...
	<?php echo form_open(get_uri("todo/save"), ["id" => "todo-inline-form", "class" => "", "role" => "form"]); ?>
   ...
   <div class="panel panel-default">
      <div class="page-title clearfix">
         ...
         <div class="title-button-group">
			 <?php echo modal_anchor(get_uri("labels/modal_form"), "<i class='fa fa-tags'></i> " . lang('manage_labels'), ["class" => "btn btn-default", "title" => lang('manage_labels'), "data-post-type" => "to_do"]); ?>
         </div>
      </div>
