<?php echo form_open(get_uri("projects/save"), ["id" => "project-form", "class" => "general-form", "role" => "form"]); ?>
   ...
   <div class="form-group">
	...
	<?php if($model_info->id){ ?>
       <div class="form-group">
          ...
          <div class=" col-md-9">
			  <?php
			  echo form_dropdown("status", ["open" => lang("open"), "completed" => lang("completed"), "hold" => lang("hold"), "canceled" => lang("canceled")], [$model_info->status], "class='select2'");
			  ?>
          </div>
       </div>
	<?php } ?>
