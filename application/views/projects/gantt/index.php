...
<div class="panel">
   <div class="tab-title clearfix">
      ...
      <div class="pull-right p10 mr10 custom-toolbar">
		  ...
		  {
			  echo lang("group_by") . " : ";
			  $milestones_and_members_group_by = ["milestones" => lang("milestones"), "members" => lang("team_members")];

			  $project_group_by = [];
			  if(!$project_id)
			  {
				  $project_group_by = ["projects" => lang("projects")];
			  }

			  $gantt_group_by = array_merge($milestones_and_members_group_by, $project_group_by);

			  echo form_dropdown("gantt-group-by", $gantt_group_by, [], "class='select2 w200 mr10 reload-gantt' id='gantt-group-by'");
		  }
		  ?>
		  <?php
		  if(!$project_id)
         ...
         <span class='dropdown-apploader-section ml10 inline-block gantt-status-filter' id="gantt-status-dropdown-container"></span>
		  ...
		  <?php
		  $gantt_view_dropdown = [
			  ["id" => "Day", "text" => lang("days_view")],
			  ["id" => "Week", "text" => lang("weeks_view")],
			  ["id" => "Month", "text" => lang("months_view")],
		  ];
...
echo modal_anchor(get_uri("projects/task_view"), "", ["id" => "show_task_hidden", "class" => "hide", "data-modal-lg" => "1"]);
?>
