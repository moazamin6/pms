   ...
   <div id="prject-comment-reply-container-<?php echo $reply->id; ?>" class="media mb15 b-l reply-container">
      ...
      <div class="media-body">
         <div class="media-heading">
			 ...
			 {
				 echo get_team_member_profile_link($reply->created_by, $reply->created_by_user, ["class" => "dark strong"]);
			 }
			 else
			 {
				 echo get_client_contact_profile_link($reply->created_by, $reply->created_by_user, ["class" => "dark strong"]);
			 }
			 ?>
			 ...
			 <?php if($this->login_user->is_admin || $reply->created_by == $this->login_user->id){ ?>
                <span class="pull-right dropdown reply-dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation"><?php echo ajax_anchor(get_uri("projects/delete_comment/$reply->id"), "<i class='fa fa-times'></i> " . lang('delete'), ["class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#prject-comment-reply-container-$reply->id"]); ?> </li>
                        </ul>
                    </span>
			 <?php } ?>
         ...
         <div class="comment-image-box clearfix">
			 ...
			 if($reply->files)
			 {
				 ...
				 if($total_files)
				 {
					 ...
					 echo anchor(get_uri("projects/download_comment_files/" . $reply->id), $download_caption, ["class" => "pull-right", "title" => $download_caption]);
				 }
			 }
			 ?>
         </div>
