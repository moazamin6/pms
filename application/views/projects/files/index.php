<div class="panel">
   <div class="tab-title clearfix">
      ...
      <div class="title-button-group">
		  ...
		  <?php echo anchor("", "<i class='fa fa fa-cloud-download'></i> " . lang("download"), ["title" => lang("download"), "id" => "download-multiple-file-btn", "class" => "btn btn-default hide"]); ?>

		  <?php
		  if($can_add_files)
		  {
			  echo modal_anchor(get_uri("projects/file_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_files'), ["class" => "btn btn-default", "title" => lang('add_files'), "data-post-project_id" => $project_id]);
		  }
		  ?>
      </div>
   </div>
