<div class="panel">
   <div class="tab-title clearfix">
      ...
      <div class="title-button-group">
		  ...
		  {
			  echo modal_anchor(get_uri("projects/milestone_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_milestone'), ["class" => "btn btn-default", "title" => lang('add_milestone'), "data-post-project_id" => $project_id]);
		  }
		  ?>
      </div>
   </div>
