<div class="row">
      ...
      <div class="clearfix">
         ...
         <div class="media m0 bg-white pl15">
            ...
            <div class="media-body w100p pt5">
               ...
               <p>
                  <span class='label label-light mr5'
                        title='Point'><?php echo get_update_task_info_anchor_data($model_info, "points", $can_edit_tasks); ?></span>
         ...
         <div class="col-md-12 mb15">
            <strong><?php echo lang('deadline') . ": "; ?></strong> <?php echo get_update_task_info_anchor_data($model_info, "deadline", $can_edit_tasks); ?>
			 <?php if($model_info->deadline_milestone_title){ ?>
                <span class="help task-deadline-milestone-tooltip" data-toggle="tooltip"
                      title="<?php echo lang('milestone') . ": " . $model_info->deadline_milestone_title; ?>"><i class="fa fa-question-circle"></i></span>
			 <?php } ?>
         </div>
		  ...
		  <?php if($model_info->recurring_task_id){ ?>
             <div class="col-md-12 mb15">
                <strong><?php echo lang('created_from') . ": "; ?> </strong>
				 <?php
				 echo modal_anchor(get_uri("projects/task_view"), lang("task") . " " . $model_info->recurring_task_id, ["title" => lang('task_info') . " #$model_info->recurring_task_id", "data-post-id" => $model_info->recurring_task_id, "data-modal-lg" => "1"]);
				 ?>
             </div>
		  <?php } ?>
		  ...
		  <?php if(get_setting("module_project_timesheet") == "1"){ ?>
             <div class="col-md-12 mb15">
                <strong><?php echo lang("total_time_logged") . ": "; ?></strong>
				 <?php
				 echo ajax_anchor(get_uri("projects/task_timesheet/" . $model_info->id . "/" . $model_info->project_id), $total_task_hours, ["data-real-target" => "#task-timesheet", "class" => "strong"]);
				 ?>
             </div>
             <div class="col-md-12 mb15">
   ...
   <div class="col-md-8 col-sm-8 col-sm-pull-4 mb15">
      <div class="clearfix">
         ...
         <!--checklist-->
		  <?php echo form_open(get_uri("projects/save_checklist_item"), ["id" => "checklist_form", "class" => "general-form", "role" => "form"]); ?>
            ...
            <div class="checklist-items" id="checklist-items">
			 ...
			 <?php if($can_edit_tasks){ ?>
                ...
                <div id="checklist-options-panel" class="mb15 p0 hide">
                   ...
                   <button id="checklist-options-panel-close" type="button" class="btn btn-default"><span
                              class="fa fa-close"></span> <?php echo lang('cancel'); ?></button>
                </div>
			 <?php } ?>
         </div>
		  <?php echo form_close(); ?>
         ...
         <!--Sub tasks-->
		  <?php echo form_open(get_uri("projects/save_sub_task"), ["id" => "sub_task_form", "class" => "general-form", "role" => "form"]); ?>
         <div class="col-md-12 mb15 b-t">
            <div class="pb10 pt10">
            ...
            <div class="checklist-items" id="sub-tasks">
			 ...
			 <?php if($can_create_tasks){ ?>
                ...
                <div id="sub-task-options-panel" class="col-md-12 mb15 p0 hide">
                   ...
                   <button id="sub-task-options-panel-close" type="button" class="btn btn-default"><span
                              class="fa fa-close"></span> <?php echo lang('cancel'); ?></button>
                </div>
			 <?php } ?>
         </div>
             ...
             <div class="col-md-12 mb15">
                    <span class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation"><?php echo js_anchor(lang("this_task_blocked_by"), ["class" => "add-dependency-btn", "data-dependency_type" => "blocked_by"]); ?></li>
                            <li role="presentation"><?php echo js_anchor(lang("this_task_blocking"), ["class" => "add-dependency-btn", "data-dependency_type" => "blocking"]); ?></li>
                        </ul>
                    </span>
             </div>
		  <?php } ?>
         ...
         <div class="col-md-12 mb15 <?php echo ($blocked_by || $blocking) ? "" : "hide"; ?>" id="dependency-area">
            ...
            <div class="p10 list-group-item mb15 <?php echo $blocking ? "" : "hide"; ?>" id="blocking-area">
			 ...
			 <?php echo form_open(get_uri("projects/save_dependency_tasks"), ["id" => "dependency_tasks_form", "class" => "general-form hide", "role" => "form"]); ?>
...
<?php if($this->login_user->user_type === "staff"){ ?>
   ...
   <div class="pl15 pr15 mt15 list-container project-activity-logs-container">
	   <?php activity_logs_widget(["limit" => 20, "offset" => 0, "log_type" => "task", "log_type_id" => $model_info->id]); ?>
   </div>
<?php } ?>