<?php echo form_open(get_uri("projects/save_task"), ["id" => "task-form", "class" => "general-form", "role" => "form"]); ?>
   <div id="tasks-dropzone" class="post-dropzone">
      <div class="modal-body clearfix">
         ...
         <div class="form-group">
		  ...
		  <?php if(!$project_id){ ?>
             <div class="form-group">
                ...
                <div class="col-md-9">
					<?php
					echo form_dropdown("project_id", $projects_dropdown, [$model_info->project_id], "class='select2 validate-hidden' id='project_id' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
					?>
                </div>
             </div>
		  <?php } ?>
         <div class="form-group">
            ...
            <div class="col-md-9">
				<?php
				echo form_dropdown("points", $points_dropdown, [$model_info->points], "class='select2'");
				?>
            </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-9">
				...
				{
					echo form_dropdown("status_id", $task_status, [$model_info->status_id], "class='select2'");
				}
				?>
            </div>
         </div>
         ...
         <div class="form-group">
		  ...
		  <?php if(get_setting("enable_recurring_option_for_tasks")){ ?>
             ...
             <div class="form-group">
                <label for="recurring" class=" col-md-3"><?php echo lang('recurring'); ?> <span class="help" data-toggle="tooltip"
             ...
             <div id="recurring_fields" class="<?php if(!$model_info->recurring){
				 echo "hide";
			 } ?>">
                <div class="form-group">
      ...
      <div class="modal-footer">
         <div id="link-of-new-view" class="hide">
			 <?php
			 echo modal_anchor(get_uri("projects/task_view"), "", ["data-modal-lg" => "1"]);
			 ?>
         </div>
         ...
         <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> <?php echo lang('close'); ?></button>
		  ...
		  <?php if($add_type == "multiple"){ ?>
             <button id="save-and-add-button" type="button" class="btn btn-primary"><span
                        class="fa fa-check-circle"></span> <?php echo lang('save_and_add_more'); ?></button>
		  <?php } else{ ?>
			  <?php if($view_type !== "details"){ ?>
                <button id="save-and-show-button" type="button" class="btn btn-info"><span
                           class="fa fa-check-circle"></span> <?php echo lang('save_and_show'); ?></button>
			  <?php } ?>
