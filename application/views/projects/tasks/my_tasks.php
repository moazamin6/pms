<div id="page-content" class="p20 clearfix">
   ...
   <ul class="nav nav-tabs bg-white title" role="tablist">
      <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo lang("tasks"); ?></h4></li>
	   ...
	   <?php $this->load->view("projects/tasks/tabs", ["active_tab" => "tasks_list"]); ?>
      ...
      <div class="tab-title clearfix no-border">
         <div class="title-button-group">
			 ...
			 {
				 echo modal_anchor("", "<i class='fa fa-pencil-square'></i> " . lang('batch_update'), ["class" => "btn btn-info hide batch-update-btn", "title" => lang('batch_update')]);
				 echo js_anchor("<i class='fa fa-check-square'></i> " . lang("batch_update"), ["class" => "btn btn-default hide batch-active-btn"]);
				 echo js_anchor("<i class='fa fa-close'></i> " . lang("cancel_selection"), ["class" => "hide btn btn-default batch-cancel-btn"]);
			 }
			 if($can_create_tasks)
			 {
				 echo modal_anchor(get_uri("projects/task_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_multiple_tasks'), ["class" => "btn btn-default", "title" => lang('add_multiple_tasks'), "data-post-add_type" => "multiple"]);
				 echo modal_anchor(get_uri("projects/task_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_task'), ["class" => "btn btn-default", "title" => lang('add_task')]);
			 }
			 ?>
         </div>
      </div>
...
if($preview_task_id)
{
	echo modal_anchor(get_uri("projects/task_view"), "", ["id" => "preview_task_link", "title" => lang('task_info') . " #$preview_task_id", "data-post-id" => $preview_task_id]);
}
