<?php if($view_type == "details"){ ?>
   ...
   <div id="page-content" class="p20 pb0 clearfix task-view-modal-body task-preview">
      <div class="row">
         <div class="col-md-12">
            <div class="panel panel-default">
               <div class="page-title clearfix">
                  <h1><?php echo lang("task_info") . " #$model_info->id"; ?></h1>
                      ...
                      <div class="title-button-group p10">
                                <span class="dropdown inline-block">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li role="presentation"><?php echo modal_anchor(get_uri("projects/task_modal_form"), "<i class='fa fa-pencil'></i> " . lang('edit_task'), ["title" => lang('edit_task'), "data-post-id" => $model_info->id, "data-post-view_type" => "details", "id" => "task-details-edit-btn"]); ?></li>
                                        <li role="presentation"><?php echo modal_anchor(get_uri("projects/task_modal_form"), "<i class='fa fa-copy'></i> " . lang('clone_task'), ["title" => lang('clone_task'), "data-post-id" => $model_info->id, "data-post-is_clone" => true, "data-post-view_type" => "details"]); ?></li>
                                    </ul>
                                </span>
                      </div>
				   <?php } ?>
               ...
               <div class="panel-body">
				   <?php $this->load->view("projects/tasks/task_view_data"); ?>
               </div>
...
<?php } else{ ?>
   ...
   <div class="modal-footer">
	   ...
	   if($can_edit_tasks)
	   {
		   echo modal_anchor(get_uri("projects/task_modal_form"), "<i class='fa fa-copy'></i> " . lang('clone_task'), ["class" => "btn btn-default pull-left", "data-post-is_clone" => true, "data-post-id" => $model_info->id, "title" => lang('clone_task')]);
		   echo modal_anchor(get_uri("projects/task_modal_form/"), "<i class='fa fa-pencil'></i> " . lang('edit_task'), ["class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit_task')]);
	   }
	   ?>
...
<?php
$task_link = anchor(get_uri("projects/task_view/$model_info->id"), '<i class="fa fa-external-link task-link-btn"></i>', ["target" => "_blank", "class" => "p15"]);
?>
...
if($can_edit_tasks)
{
	$this->load->view("projects/tasks/update_task_info_script");
}
?>