<div id="page-content" class="p20 clearfix">
   <div class="panel panel-default">
      <ul id="project-all-timesheet-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
         ...
         <li><a id="timesheet-details-button" class="active" role="presentation" href="javascript:;"
                data-target="#timesheet-details"><?php echo lang("details"); ?></a></li>
         <li><a role="presentation" href="<?php echo_uri("projects/all_timesheet_summary/"); ?>"
      ...
      $("#all-project-timesheet-table").appTable({
         ...
         filterDropdown: [
            {name: "user_id", class: "w200", options: <?php echo $members_dropdown; ?>},
            {
               ...
               dataSource: '<?php echo_uri("projects/get_projects_of_selected_client_for_filter") ?>',
               selfDependency: true
            }, //projects are dependent on client. but we have to show all projects, if there is no selected client
