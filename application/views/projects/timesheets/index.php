<div class="panel panel-default">
   <ul id="project-timesheet-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
      ...
      <li><a role="presentation" href="<?php echo_uri("projects/timesheet_summary/" . $project_id); ?>"
             data-target="#timesheet-summary"><?php echo lang('summary'); ?></a></li>
      <li><a role="presentation" href="<?php echo_uri("projects/timesheet_chart/" . $project_id); ?>"
             data-target="#timesheet-chart"><?php echo lang('chart'); ?></a></li>
      ...
      <div class="tab-title clearfix no-border">
         <div class="title-button-group">
			 ...
			 if($can_add_log)
			 {
				 echo modal_anchor(get_uri("projects/timelog_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('log_time'), ["class" => "btn btn-default", "title" => lang('log_time'), "data-post-project_id" => $project_id]);
			 }
			 ?>
         </div>
      </div>
   ...
   $(document).ready(function () {
          ...
          $("#project-timesheet-table").appTable({
             ...
             filterDropdown: [{name: "user_id", class: "w200", options: <?php echo $project_members_dropdown; ?>}, {
                name: "task_id",
                class: "w200",
                options: <?php echo $tasks_dropdown; ?>}],
