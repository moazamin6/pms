<?php echo form_open(get_uri("projects/save_timelog"), ["id" => "timelog-form", "class" => "general-form", "role" => "form"]); ?>
   ...
   <input type="hidden" name="project_id" value="<?php echo $project_id; ?>"/>
	...
	<?php if(!$project_id){ ?>
       <div class="form-group">
          ...
          <div class="col-md-9">
			  <?php
			  echo form_dropdown("project_id", $projects_dropdown, [], "class='select2 validate-hidden' id='project_id' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
			  ?>
          </div>
       </div>
	<?php } ?>
	...
	<?php if((get_setting("users_can_input_only_total_hours_instead_of_period") && (!$model_info->id || $model_info->hours)) || (!get_setting("users_can_input_only_total_hours_instead_of_period") && $model_info->hours)){ ?>
       <label for="date" class=" col-md-3 col-sm-3"><?php echo lang('date'); ?></label>
       ...
       <label for="hours" class=" col-md-2 col-sm-2"><?php echo lang('hours'); ?></label>
       <div class=" col-md-3 col-sm-3 form-group">
		   ...
		   echo form_input([
			   ...
			   "class"              => "form-control",
			   "placeholder"        => lang('timesheet_hour_input_help_message'),
			   "data-rule-required" => true,
			   "data-msg-required"  => lang("field_required"),
		   ]);
		   ?>
