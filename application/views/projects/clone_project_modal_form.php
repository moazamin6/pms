<?php echo form_open(get_uri("projects/save_cloned_project"), ["id" => "project-form", "class" => "general-form", "role" => "form"]); ?>
<div class="modal-body clearfix">
   ...
   <div class="form-group">
      ...
      <div class=" col-md-9">
		  <?php
		  echo form_dropdown("client_id", $clients_dropdown, [$model_info->client_id], "class='select2 validate-hidden' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
		  ?>
      </div>
   </div>
   <div class="form-group">
   ...
   <div class="form-group">
      <label for="move_all_tasks_to_to_do" class=" col-md-12">
		  <?php
		  echo form_checkbox("move_all_tasks_to_to_do", "1", false, "id='move_all_tasks_to_to_do'  class='pull-left '");
		  ?>
         <span class="pull-left ml15"> <?php echo lang('move_all_tasks_to_to_do'); ?> </span>
      </label>
   </div>
