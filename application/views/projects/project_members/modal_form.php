<?php echo form_open(get_uri("projects/save_project_member"), ["id" => "project-member-form", "class" => "general-form", "role" => "form"]); ?>
      ...
      <div class="col-md-9">
         <div class="select-member-field">
            <div class="select-member-form clearfix pb10">
				<?php echo form_dropdown("user_id[]", $users_dropdown, [$model_info->user_id], "class='user_select2 col-md-10 p0'"); ?>
				<?php echo js_anchor("<i class='fa fa-times'></i> ", ["class" => "remove-member delete ml20"]); ?>
            </div>
         </div>
		  <?php echo js_anchor("<i class='fa fa-plus-circle'></i> " . lang('add_more'), ["class" => "add-member", "id" => "add-more-user"]); ?>
      </div>
   </div>
