<div class="panel no-border">
   <div class="tab-title clearfix">
      ...
      <div class="title-button-group">
		  ...
		  {
			  echo modal_anchor(get_uri("projects/project_member_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_member'), ["class" => "btn btn-default", "title" => lang('add_member'), "data-post-project_id" => $project_id]);
		  }
		  ?>
      </div>
   </div>
