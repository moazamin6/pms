      ...
      <div class="page-title clearfix">
         ...
         <div class="title-button-group">
			 ...
			 if($can_create_projects)
			 {
				 ...
				 {
					 echo modal_anchor(get_uri("labels/modal_form"), "<i class='fa fa-tags'></i> " . lang('manage_labels'), ["class" => "btn btn-default", "title" => lang('manage_labels'), "data-post-type" => "project"]);
				 }

				 echo modal_anchor(get_uri("projects/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_project'), ["class" => "btn btn-default", "title" => lang('add_project')]);
			 }
			 ?>
         </div>
      </div>
