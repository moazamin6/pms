<?php echo form_open(get_uri("projects/save_settings"), ["id" => "project-settings-form", "class" => "general-form", "role" => "form"]); ?>
...
<div class="modal-footer">
   <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> <?php echo lang('close'); ?></button>
	...
	<?php if($can_edit_slack_settings){ ?>
       <button id="test-slack-btn" type="button"
               class="btn btn-info <?php echo (get_setting("project_enable_slack") && get_setting("project_slack_webhook_url")) ? "" : "hide"; ?>"><span
                  class="fa fa-check-circle"></span> <?php echo lang('save_and_send_a_test_message'); ?></button>
	<?php } ?>
