<li class="hidden-xs">
	<?php echo ajax_anchor(get_uri("projects/show_my_starred_projects/"), "<i class='fa fa-th-large starred-icon'></i>", ["class" => "dropdown-toggle", "data-toggle" => "dropdown", "data-real-target" => "#projects-quick-list-container"]); ?>
