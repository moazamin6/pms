      ...
      <div class="signin-box">
         <div class="panel panel-default clearfix">
            ...
            <div class="panel-body">
				...
				echo form_open($action_url, ["id" => "signup-form", "class" => "general-form", "role" => "form"]);
				?>
				...
				<?php } else{ ?>
                   ...
                   <div class="form-group">
					...
					<?php } else{
						if($signup_type === "verify_email" && isset($key)){ ?>
                      ...
                      <div class="form-group">
                         <div class="col-md-12">
                            <label for="i_accept_the_terms_and_conditions" class="input-group">
								...
								?>
                               <span class="ml10"><?php echo lang('i_accept_the_terms_and_conditions') . " " . anchor(get_setting("gdpr_terms_and_conditions_link"), lang("gdpr_terms_and_conditions") . ".", ["target" => "_blank"]); ?> </span>
                            </label>
                         </div>
                      </div>
					<?php } ?>
               ...
               <div class="form-group">
                  <div class=" col-md-12">
                     <button class="btn btn-lg btn-primary btn-block"
                             type="submit"><?php echo $signup_type == "send_verify_email" ? lang("get_started") : lang('signup'); ?></button>
                  </div>
               </div>
            </div>
			 <?php echo form_close(); ?>
