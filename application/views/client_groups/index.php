         ...
         <div class="panel panel-default">
            <div class="page-title clearfix">
               ...
               <div class="title-button-group">
				   <?php echo modal_anchor(get_uri("client_groups/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_client_group'), ["class" => "btn btn-default", "title" => lang('add_client_group')]); ?>
               </div>
            </div>
