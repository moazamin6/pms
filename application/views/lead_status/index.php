            ...
            <ul data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
               ...
               <div class="tab-title clearfix no-border">
                  <div class="title-button-group">
					  <?php echo modal_anchor(get_uri("lead_status/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_lead_status'), ["class" => "btn btn-default", "title" => lang('add_lead_status'), "id" => "lead-status-source-add-btn"]); ?>
                  </div>
               </div>
            </ul>
