   ...
   <div class="panel panel-default">
      <div class="page-title clearfix">
         ...
         <div class="title-button-group">
			 ...
			 if($show_add_button)
			 {
				 echo anchor(get_uri("announcements/form"), "<i class='fa fa-plus-circle'></i> " . lang('add_announcement'), ["class" => "btn btn-default", "data-modal-lg" => "1", "title" => lang('add_announcement')]);
			 };
			 ?>
         </div>
      </div>
...
<script type="text/javascript">
   $(document).ready(function () {
      ...
      var showOption = true;
      if (("<?php echo $this->login_user->user_type; ?>" === "client") || ("<?php if(!$show_option){
		  echo "0";
	  } ?>" === "0")) {
         showOption = false;
      }
