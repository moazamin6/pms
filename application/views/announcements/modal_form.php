<div id="page-content" class="clearfix p20">
   <div class="panel view-container">
      <div id="announcement-dropzone" class="post-dropzone">
		  <?php echo form_open(get_uri("announcements/save"), ["id" => "announcement-form", "class" => "general-form", "role" => "form"]); ?>
            ...
            <div class="page-title clearfix">
				<?php if($model_info->id){ ?>
                   ...
                   <div class="title-button-group">
					   <?php echo anchor(get_uri("announcements/view/" . $model_info->id), "<i class='fa fa-external-link-square'></i> " . lang('view'), ["class" => "btn btn-default", "title" => lang('view')]); ?>
                   </div>
				<?php } else{ ?>
