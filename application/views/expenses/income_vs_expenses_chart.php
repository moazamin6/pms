<div id="page-content" class="clearfix p20">
   <div class="panel clearfix">
      <ul id="income-vs-expenses-chart-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white inner clearfix" role="tablist">
         ...
         <li><a id="income-vs-expenses-chart-button" role="presentation" class="active" href="javascript:;"
                data-target="#income-vs-expenses-chart-tab"><?php echo lang("chart"); ?></a></li>
         <li><a role="presentation" href="<?php echo_uri("expenses/income_vs_expenses_summary/"); ?>"
                data-target="#income-vs-expenses-summary"><?php echo lang("summary"); ?></a></li>
         <span class="help pull-right p15" data-toggle="tooltip" data-placement="left" title="<?php echo lang('income_expenses_widget_help_message') ?>"><i
