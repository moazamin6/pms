<?php echo form_open(get_uri("expenses/save"), ["id" => "expense-form", "class" => "general-form", "role" => "form"]); ?>
<div id="expense-dropzone" class="post-dropzone">
   <div class="modal-body clearfix">
      ...
      <div class="form-group">
         ...
         <div class="col-md-9">
			 <?php
			 echo form_dropdown("tax_id", $taxes_dropdown, [$model_info->tax_id], "class='select2'");
			 ?>
         </div>
      </div>
      ...
      <div class="form-group">
         ...
         <div class="col-md-9">
			 <?php
			 echo form_dropdown("tax_id2", $taxes_dropdown, [$model_info->tax_id2], "class='select2'");
			 ?>
         </div>
      </div>

      <div class="form-group">
         <label for="expense_recurring" class=" col-md-3"><?php echo lang('recurring'); ?> <span class="help" data-toggle="tooltip"
