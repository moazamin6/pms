      ...
      <div class="col-sm-9 col-lg-10">
         ...
         <div class="panel panel-default no-border clearfix ">
            ...
            <ul id="custom-field-tab" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
               ...
               <li><a role="presentation" data-related_to="clients" class="active" href="javascript:;"
                      data-target="#custom-field-clients"><?php echo lang("clients"); ?></a></li>
               <li><a role="presentation" data-related_to="client_contacts" class="" href="<?php echo_uri("custom_fields/client_contacts/"); ?>"
                      data-target="#custom-field-client_contacts"><?php echo lang("client_contacts"); ?></a></li>
               <li><a role="presentation" data-related_to="leads" class="active" href="<?php echo_uri("custom_fields/leads/"); ?>"
                      data-target="#custom-field-leads"><?php echo lang("leads"); ?></a></li>
               <li><a role="presentation" data-related_to="lead_contacts" class="" href="<?php echo_uri("custom_fields/lead_contacts/"); ?>"
                      data-target="#custom-field-lead_contacts"><?php echo lang("lead_contacts"); ?></a></li>
               <li><a role="presentation" data-related_to="projects" href="<?php echo_uri("custom_fields/projects/"); ?>"
                      data-target="#custom-field-projects"><?php echo lang('projects'); ?></a></li>
               <li><a role="presentation" data-related_to="tasks" href="<?php echo_uri("custom_fields/tasks/"); ?>"
                      data-target="#custom-field-tasks"><?php echo lang('tasks'); ?></a></li>
               <li><a role="presentation" data-related_to="team_members" href="<?php echo_uri("custom_fields/team_members/"); ?>"
                      data-target="#custom-field-team_members"><?php echo lang('team_members'); ?></a></li>
               <li><a role="presentation" data-related_to="tickets" href="<?php echo_uri("custom_fields/tickets/"); ?>"
                      data-target="#custom-field-tickets"><?php echo lang('tickets'); ?></a></li>
               <li><a role="presentation" data-related_to="invoices" href="<?php echo_uri("custom_fields/invoices/"); ?>"
                      data-target="#custom-field-invoices"><?php echo lang('invoices'); ?></a></li>
               <li><a role="presentation" data-related_to="events" href="<?php echo_uri("custom_fields/events/"); ?>"
                      data-target="#custom-field-events"><?php echo lang('events'); ?></a></li>
               <li><a role="presentation" data-related_to="expenses" href="<?php echo_uri("custom_fields/expenses/"); ?>"
                      data-target="#custom-field-expenses"><?php echo lang('expenses'); ?></a></li>
               <li><a role="presentation" data-related_to="estimates" href="<?php echo_uri("custom_fields/estimates/"); ?>"
                      data-target="#custom-field-estimates"><?php echo lang('estimates'); ?></a></li>
               <li><a role="presentation" data-related_to="orders" href="<?php echo_uri("custom_fields/orders/"); ?>"
                      data-target="#custom-field-orders"><?php echo lang('orders'); ?></a></li>
               <li><a role="presentation" data-related_to="timesheets" href="<?php echo_uri("custom_fields/timesheets/"); ?>"
                      data-target="#custom-field-timesheets"><?php echo lang('timesheets'); ?></a></li>
               <div class="tab-title clearfix no-border">
                  <div class="title-button-group">
					  <?php echo modal_anchor(get_uri("custom_fields/modal_form/"), "<i class='fa fa-plus-circle'></i> " . lang('add_field'), ["class" => "btn btn-default", "id" => "add-field-button", "data-post-related_to" => "clients", "title" => lang('add_field')]); ?>
                  </div>
               </div>
            </ul>
