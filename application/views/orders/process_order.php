	...
	<?php if($cart_items_count){ ?>
       <div class="process-order-preview">
          <div class="panel panel-default">
			  ...
			  <?php echo form_open(get_uri("orders/place_order"), ["id" => "place-order-form", "class" => "general-form", "role" => "form"]); ?>
             ...
             <div class="panel-footer clearfix">
                <button type="submit" class="btn btn-primary pull-right ml10"><span class="fa fa-check-circle"></span> <?php echo lang('place_order'); ?>
                </button>
				 <?php echo anchor(get_uri("items/grid_view"), "<i class='fa fa-plus-circle'></i> " . lang('add_more_items'), ["class" => "btn btn-default pull-right"]); ?>
             </div>
