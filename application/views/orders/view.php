         ...
         <div class="title-button-group">
                <span class="dropdown inline-block">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li role="presentation"><?php echo anchor(get_uri("orders/download_pdf/" . $order_info->id), "<i class='fa fa-download'></i> " . lang('download_pdf'), ["title" => lang('download_pdf'),]); ?> </li>
                        <li role="presentation"><?php echo anchor(get_uri("orders/download_pdf/" . $order_info->id . "/view"), "<i class='fa fa-file-pdf-o'></i> " . lang('view_pdf'), ["title" => lang('view_pdf'), "target" => "_blank"]); ?> </li>
                        <li role="presentation"><?php echo anchor(get_uri("orders/preview/" . $order_info->id . "/1"), "<i class='fa fa-search'></i> " . lang('order_preview'), ["title" => lang('order_preview')], ["target" => "_blank"]); ?> </li>
                        <li role="presentation" class="divider"></li>
                        <li role="presentation"><?php echo modal_anchor(get_uri("orders/modal_form"), "<i class='fa fa-edit'></i> " . lang('edit_order'), ["title" => lang('edit_order'), "data-post-id" => $order_info->id, "role" => "menuitem", "tabindex" => "-1"]); ?> </li>

                        <li role="presentation" class="divider"></li>
                        <?php if($show_estimate_option){ ?>
                           <li role="presentation"><?php echo modal_anchor(get_uri("estimates/modal_form/"), "<i class='fa fa-file'></i> " . lang('create_estimate'), ["title" => lang("create_estimate"), "data-post-order_id" => $order_info->id]); ?> </li>
						<?php } ?>
						<?php if($show_invoice_option){ ?>
                           <li role="presentation"><?php echo modal_anchor(get_uri("invoices/modal_form/"), "<i class='fa fa-file-text'></i> " . lang('create_invoice'), ["title" => lang("create_invoice"), "data-post-order_id" => $order_info->id]); ?> </li>
						<?php } ?>

                    </ul>
                </span>
			 <?php echo modal_anchor(get_uri("orders/item_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_item'), ["class" => "btn btn-default", "title" => lang('add_item'), "data-post-order_id" => $order_info->id]); ?>
         </div>
      </div>
...
<?php $this->load->view("orders/update_order_status_script", ["details_view" => true]); ?>