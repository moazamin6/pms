<div id="page-content" class="p20 clearfix">
   <div class="panel clearfix">
      <ul id="order-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
         ...
         <li><a id="monthly-order-button" class="active" role="presentation" href="javascript:;"
                data-target="#monthly-orders"><?php echo lang("monthly"); ?></a></li>
         <li><a role="presentation" href="<?php echo_uri("orders/yearly/"); ?>" data-target="#yearly-orders"><?php echo lang('yearly'); ?></a></li>

         <div class="tab-title clearfix no-border">
            <div class="title-button-group">
				<?php echo js_anchor("<i class='fa fa-plus-circle'></i> " . lang('add_order'), ["class" => "btn btn-default", "id" => "add-order-btn"]); ?>
            </div>
         </div>
      </ul>
