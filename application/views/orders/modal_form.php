<?php echo form_open(get_uri("orders/save"), ["id" => "order-form", "class" => "general-form", "role" => "form"]); ?>
<div class="modal-body clearfix">
   ...
   <div class="form-group">
	...
	<?php } else{ ?>
       <div class="form-group">
          ...
          <div class="col-md-9">
			  <?php
			  echo form_dropdown("order_client_id", $clients_dropdown, [$model_info->client_id], "class='select2 validate-hidden' id='order_client_id' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
			  ?>
          </div>
       </div>
	<?php } ?>
   ...
   <div class="form-group">
      ...
      <div class="col-md-9">
		  ...
		  echo form_dropdown("status_id", $order_status, [$model_info->status_id], "class='select2'");
		  ?>
      </div>
   </div>
