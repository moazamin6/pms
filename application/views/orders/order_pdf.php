<div style=" margin: auto;">
	...
	$discount_row = '<tr>
                        ...
                        <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">' . to_currency($order_total_summary->discount_total, $order_total_summary->currency_symbol) . '</td>
                    </tr>';
	?>
</div>
...
<table class="table-responsive" style="width: 100%; color: #444;">
   ...
   <tr>
      ...
      <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
		  <?php echo to_currency($order_total_summary->order_subtotal, $order_total_summary->currency_symbol); ?>
      </td>
   </tr>
	<?php
	...
	<?php if($order_total_summary->tax){ ?>
       <tr>
          ...
          <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
			  <?php echo to_currency($order_total_summary->tax, $order_total_summary->currency_symbol); ?>
          </td>
       </tr>
	<?php } ?>
	<?php if($order_total_summary->tax2){ ?>
       <tr>
          ...
          <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
			  <?php echo to_currency($order_total_summary->tax2, $order_total_summary->currency_symbol); ?>
          </td>
       </tr>
	<?php } ?>
	<?php
   ...
   <tr>
      ...
      <td style="text-align: right; width: 20%; background-color: <?php echo $color; ?>; color: #fff;">
		  <?php echo to_currency($order_total_summary->order_total, $order_total_summary->currency_symbol); ?>
      </td>
   </tr>
</table>
