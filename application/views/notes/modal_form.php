<?php echo form_open(get_uri("notes/save"), ["id" => "note-form", "class" => "general-form", "role" => "form"]); ?>
		   ...
		   <?php } else{ ?>
             <div class="form-group">
                <label for="mark_as_public" class=" col-md-12">
                   ...
                   <span id="mark_as_public_help_message" class="ml10 hide"><i
                              class="fa fa-warning text-warning"></i> <?php echo lang("mark_as_public_help_message"); ?></span>
                </label>
             </div>
		   <?php } ?>
	   <?php } ?>
