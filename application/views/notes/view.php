...
<div class="modal-footer">
	...
	{
		echo modal_anchor(get_uri("notes/modal_form/"), "<i class='fa fa-pencil'></i> " . lang('edit_note'), ["class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit_note')]);
	}
	?>
