      ...
      <ul id="client-estimate-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
         ...
         <li><a role="presentation" class="active" href="javascript:;" data-target="#esimates-tab"><?php echo lang("estimates"); ?></a></li>
		  <?php if(isset($can_request_estimate) && $can_request_estimate){ ?>
             <li><a role="presentation" href="<?php echo_uri("estimate_requests/estimate_requests_for_client/" . $client_id); ?>"
                    data-target="#esimate-requests-tab"><?php echo lang('estimate_requests'); ?></a></li>
             <div class="tab-title clearfix no-border">

                <div class="title-button-group">
					<?php echo modal_anchor(get_uri("estimate_requests/request_an_estimate_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('request_an_estimate'), ["class" => "btn btn-default", "title" => lang('request_an_estimate')]); ?>
                </div>
