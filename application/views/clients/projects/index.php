	   ...
	   <?php if(isset($page_type) && $page_type === "full"){ ?>
          <div class="page-title clearfix">
             ...
             <div class="title-button-group">
				 ...
				 {
					 echo modal_anchor(get_uri("projects/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_project'), ["class" => "btn btn-default", "data-post-client_id" => $client_id, "title" => lang('add_project')]);
				 }
				 ?>
             </div>
          </div>
