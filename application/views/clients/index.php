         ...
         <div class="tab-title clearfix no-border">
            <div class="title-button-group">
				<?php if($can_edit_clients){ ?>
					<?php echo modal_anchor(get_uri("clients/import_clients_modal_form"), "<i class='fa fa-upload'></i> " . lang('import_clients'), ["class" => "btn btn-default", "title" => lang('import_clients')]); ?>
					<?php echo modal_anchor(get_uri("clients/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_client'), ["class" => "btn btn-default", "title" => lang('add_client')]); ?>
				<?php } ?>
            </div>
         </div>
      </ul>
