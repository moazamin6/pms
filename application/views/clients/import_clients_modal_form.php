<?php echo form_open(get_uri("clients/save_client_from_excel_file"), ["id" => "import-client-form", "class" => "general-form", "role" => "form"]); ?>
<div class="modal-body clearfix import-client-modal-body">
   <div id="upload-area">
	   <?php
	   $this->load->view("includes/multi_file_uploader", [
...
<div class="modal-footer">
	<?php echo anchor("clients/download_sample_excel_file", "<i class='fa fa-cloud-download'></i> " . lang("download_sample_file"), ["title" => lang("download_sample_file"), "class" => "btn btn-default pull-left"]); ?>
   ...
   <button id="form-next" type="button" disabled="true" class="btn btn-info"><span class="fa  fa-arrow-circle-right"></span> <?php echo lang('next'); ?>
   </button>
   <button id="form-submit" type="button" disabled="true" class="btn btn-primary start-upload hide"><span
              class="fa fa-check-circle"></span> <?php echo lang('upload'); ?></button>
</div>
<?php echo form_close(); ?>
