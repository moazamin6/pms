<div class="tab-content">
	...
	echo form_open(get_uri("clients/save_my_preferences/"), ["id" => "my-preferences-form", "class" => "general-form dashed-row white", "role" => "form"]);
	?>
   <div class="panel">
      ...
      <div class="panel-body">
         ...
         <div class="form-group">
            ...
            <div class=" col-md-3">
			 ...
			 <?php echo modal_anchor(get_uri("clients/keyboard_shortcut_modal_form/"), "<i class='fa fa-info'></i>", ["class" => "btn btn-default keyboard-shortcut-info-icon", "title" => lang('keyboard_shortcuts_info'), "data-post-user_id" => $this->login_user->id]); ?>
         </div>
