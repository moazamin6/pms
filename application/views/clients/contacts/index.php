   ...
   <div class="panel">
      <div class="tab-title clearfix">
         ...
         <div class="title-button-group">
			 ...
			 if($can_edit_clients)
			 {
				 echo modal_anchor(get_uri("clients/invitation_modal"), "<i class='fa fa-envelope-o'></i> " . lang('send_invitation'), ["class" => "btn btn-default", "title" => lang('send_invitation'), "data-post-client_id" => $client_id]);

				 echo modal_anchor(get_uri("clients/add_new_contact_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_contact'), ["class" => "btn btn-default", "title" => lang('add_contact'), "data-post-client_id" => $client_id]);
			 }
			 ?>
         </div>
      </div>
