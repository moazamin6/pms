	   ...
	   <?php } else{ ?>
          <div class="tab-title clearfix">
             ...
             <div class="title-button-group">
				 ...
				 {
					 echo modal_anchor(get_uri("invoices/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_invoice'), ["class" => "btn btn-default mb0", "data-post-client_id" => $client_id, "title" => lang('add_invoice')]);
				 }
				 ?>
             </div>
          </div>
