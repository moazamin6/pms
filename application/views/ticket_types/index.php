      ...
      <div class="col-sm-9 col-lg-10">
         <div class="panel panel-default">
            ...
            <ul id="ticket-type-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
               ...
               <li><a role="presentation" href="<?php echo_uri("settings/imap_settings/"); ?>"
                      data-target="#imap_settings-tab"><?php echo lang('imap_settings'); ?></a></li>
               <div class="tab-title clearfix no-border">
                  <div class="title-button-group">
					  <?php echo modal_anchor(get_uri("ticket_types/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_ticket_type'), ["class" => "btn btn-default", "title" => lang('add_ticket_type')]); ?>
                  </div>
               </div>
            </ul>
