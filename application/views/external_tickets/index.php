...
<div id="page-content" class="p20 clearfix">
   <div id="external-ticket-form-container">
	   ...
	   <?php echo form_open(get_uri("external_tickets/save"), ["id" => "ticket-form", "class" => "general-form", "role" => "form"]); ?>
      <div id="new-ticket-dropzone" class="panel panel-default p15 no-border clearfix post-dropzone client-info-section"
         ...
         <div class="p15">
            <button class="btn btn-default upload-file-button mr15 round" type="button" style="color:#7988a2"><i
