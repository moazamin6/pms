   ...
   <div class="row">
      <div class="col-md-4">
         <div class="bg-white text-center">
            ...
            <div style="overflow-x: hidden" id="menu-item-list-1"
                 class="js-left-menu-scrollbar available-items-container menu-item-list p15 pt0"><?php echo $available_items; ?></div>
         </div>
      </div>
      ...
      <div class="col-md-4">
         <div class="bg-white">
            ...
            <div class="p15 pt0"><?php echo modal_anchor(get_uri("left_menus/add_menu_item_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_menu_item'), ["class" => "btn btn-default block custom-menu-item-add-button", "title" => lang('add_menu_item')]); ?></div>
         </div>
      </div>
