<div id="page-content" class="p20 clearfix">
   ...
   <div class="panel panel-default">
      <ul id="attendance-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
         ...
         <li><a role="presentation" href="<?php echo_uri("attendance/summary_details/"); ?>"
                data-target="#summary-attendance-details"><?php echo lang('summary_details'); ?></a></li>
         <li><a role="presentation" href="<?php echo_uri("attendance/members_clocked_in/"); ?>"
                data-target="#members-clocked-in"><?php echo lang('members_clocked_in'); ?></a></li>
         ...
         <div class="tab-title clearfix no-border">
            <div class="title-button-group">
				<?php echo modal_anchor(get_uri("attendance/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_attendance'), ["class" => "btn btn-default", "title" => lang('add_attendance')]); ?>
            </div>
         </div>
      </ul>
   ...
   $(document).ready(function () {
      ...
      setTimeout(function () {
         ...
         if (tab === "members_clocked_in") {
            $("[data-target=#members-clocked-in]").trigger("click");
         }
      }, 210);
