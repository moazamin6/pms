         ...
         <div class="panel panel-default">
            <div class="page-title clearfix">
               ...
               <div class="title-button-group">
				   <?php echo modal_anchor(get_uri("expense_categories/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_category'), ["class" => "btn btn-default", "title" => lang('add_category')]); ?>
               </div>
            </div>
