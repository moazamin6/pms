	...
	if(count($files))
	{
		...
		foreach($files as $file)
		{
			...
			if($image_only && is_viewable_image_file($file_name))
			{
				...
				echo "<div class='saved-file-item-container'><div class='col-md-3 col-sm-6 pr0'><div style='background-image: url($thumbnail)' class='edit-image-file mb15' ><a href='#' class='delete-saved-file' data-file_name='$file_name'><span class='fa fa-close'></span></a></div></div></div>";
			}
			else
			{
