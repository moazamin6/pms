<?php load_js(["assets/js/push_notification/pusher/pusher.min.js"]); ?>
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="default-navbar">
   ...
   <div id="navbar" class="navbar-collapse collapse">
      ...
      <ul class="nav navbar-nav navbar-right inline-block">
		  ...
		  {
			  load_js(["assets/js/awesomplete/awesomplete.min.js"]);
			  ?>
             <li class="hidden-xs" title="<?php echo lang('search') . ' (/)'; ?>" data-toggle="tooltip" data-placement="left">
				 <?php echo modal_anchor(get_uri("search/search_modal_form"), "<i class='fa fa-search'></i>", ["class" => "pull-left", "data-modal-title" => lang('search') . ' (/)', "data-post-hide-header" => true, "id" => "global-search-btn"]); ?>
             </li>
		  <?php } ?>
		  ...
		  <?php if(!in_array("language", $hidden_topbar_menus) && (($this->login_user->user_type == "staff" && !get_setting("disable_language_selector_for_team_members")) || ($this->login_user->user_type == "client" && !get_setting("disable_language_selector_for_clients")))){ ?>
             ...
             <li class="user-language-option">
				 <?php echo js_anchor("<i class='fa fa-globe'></i>", ["id" => "personal-language-icon", "class" => "dropdown-toggle", "data-toggle" => "dropdown"]); ?>
                ...
                <ul class="dropdown-menu p0" style="height: 300px; overflow-y: scroll; min-width: 170px;">
                   <li>
					   ...
					   foreach(get_language_list() as $language)
					   {
						   ...
						   if($this->login_user->user_type == "staff")
						   {
							   echo ajax_anchor(get_uri("team_members/save_personal_language/$language"), $language_text . $language_status, ["class" => "clearfix", "data-reload-on-success" => "1"]);
						   }
						   else
						   {
							   echo ajax_anchor(get_uri("clients/save_personal_language/$language"), $language_text . $language_status, ["class" => "clearfix", "data-reload-on-success" => "1"]);
						   }
					   }
					   ?>
                   </li>
         ...
         <li class="">
			 <?php echo js_anchor("<i class='fa fa-bell-o'></i>", ["id" => "web-notification-icon", "class" => "dropdown-toggle", "data-toggle" => "dropdown"]); ?>
		  ...
		  <?php if(get_setting("module_message") && can_access_messages_module()){ ?>
             <li class=" <?php echo ($this->login_user->user_type === "client" && !get_setting("client_message_users")) ? "hide" : ""; ?>">
				 <?php echo js_anchor("<i class='fa fa-envelope-o'></i>", ["id" => "message-notification-icon", "class" => "dropdown-toggle", "data-toggle" => "dropdown"]); ?>
         ...
         <li class="dropdown pr15 dropdown-user">
            <a id="user-dropdown-icon" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                    ...
                    </span><span class="topbar-user-name"><?php echo $this->login_user->first_name . " " . $this->login_user->last_name; ?></span> <span
                       class="caret"></span></a>
