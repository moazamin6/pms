<script type="text/javascript">
   ...
   AppLanugage.days = <?php echo json_encode([lang("sunday"), lang("monday"), lang("tuesday"), lang("wednesday"), lang("thursday"), lang("friday"), lang("saturday")]); ?>;
   AppLanugage.daysShort = <?php echo json_encode([lang("short_sunday"), lang("short_monday"), lang("short_tuesday"), lang("short_wednesday"), lang("short_thursday"), lang("short_friday"), lang("short_saturday")]); ?>;
   AppLanugage.daysMin = <?php echo json_encode([lang("min_sunday"), lang("min_monday"), lang("min_tuesday"), lang("min_wednesday"), lang("min_thursday"), lang("min_friday"), lang("min_saturday")]); ?>;

   AppLanugage.months = <?php echo json_encode([lang("january"), lang("february"), lang("march"), lang("april"), lang("may"), lang("june"), lang("july"), lang("august"), lang("september"), lang("october"), lang("november"), lang("december")]); ?>;
   AppLanugage.monthsShort = <?php echo json_encode([lang("short_january"), lang("short_february"), lang("short_march"), lang("short_april"), lang("short_may"), lang("short_june"), lang("short_july"), lang("short_august"), lang("short_september"), lang("short_october"), lang("short_november"), lang("short_december")]); ?>;
