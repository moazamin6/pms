...
<?php echo form_open(get_uri("leaves/update_status"), ["id" => "leave-status-form", "class" => "general-form", "role" => "form"]); ?>
...
<div class="modal-footer">
   <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><span class="fa fa-close"></span> <?php echo lang('close'); ?></button>
	<?php if($leave_info->status === "pending" && $this->login_user->id === $leave_info->applicant_id){ ?>
       <button data-status="canceled" type="submit" class="btn btn-danger btn-sm update-leave-status"><span
                  class="fa fa-times-circle-o"></span> <?php echo lang('cancel'); ?></button>
	<?php } ?>
	<?php if($leave_info->status === "pending" && $show_approve_reject){ ?>
       <button data-status="rejected" type="submit" class="btn btn-danger btn-sm update-leave-status"><span
                  class="fa fa-times-circle-o"></span> <?php echo lang('reject'); ?></button>
       <button data-status="approved" type="submit" class="btn btn-success btn-sm update-leave-status"><span
                  class="fa fa-check-circle-o"></span> <?php echo lang('approve'); ?></button>
	<?php } ?>
</div>
<?php echo form_close(); ?>
