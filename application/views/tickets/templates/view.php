...
<div class="modal-footer">
	...
	{
		echo modal_anchor(get_uri("tickets/ticket_template_modal_form/"), "<i class='fa fa-pencil'></i> " . lang('edit'), ["class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit_template')]);
	}
	?>
