<div id="page-content" class="p20 pb0 clearfix">
   ...
   <ul class="nav nav-tabs bg-white title" role="tablist">
      <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo lang("tickets"); ?></h4></li>
	   ...
	   <?php $this->load->view("tickets/index", ["active_tab" => "ticket_templates"]); ?>

      <div class="tab-title clearfix no-border">
         <div class="title-button-group">
			 <?php echo modal_anchor(get_uri("tickets/ticket_template_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_template'), ["class" => "btn btn-default", "title" => lang('add_template')]); ?>
         </div>
      </div>
