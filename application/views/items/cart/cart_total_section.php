<div class="strong">
   ...
   <div class="clearfix">
      ...
      <div class="pull-right cart-total-value"
           data-value="<?php echo $order_total_summary->order_total; ?>"><?php echo to_currency($order_total_summary->order_total, $order_total_summary->currency_symbol); ?></div>
   </div>
</div>