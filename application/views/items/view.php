      ...
      <div class="col-md-12">
         <strong class="font-18"><?php echo $model_info->title; ?></strong>
		  <?php if($model_info->show_in_client_portal && $this->login_user->is_admin && get_setting("module_order")){ ?>
             <span class="ml5 text-off font-11" data-toggle="tooltip" data-placement="right" title="<?php echo lang('showing_in_client_portal'); ?>"><i
			...
			if($this->login_user->is_admin && get_setting("module_order"))
			{
               ...
               <div class="col-md-12 mt15">
                  <div class="mb15 text-off"><i class="fa fa-question-circle"></i> <?php echo lang("item_image_sorting_help_message"); ?></div>
				   <?php $this->load->view("includes/sortable_file_list", ["files" => $model_info->files, "action_url" => get_uri("items/save_files_sort"), "id" => $model_info->id]); ?>
               </div>
				<?php
			}
		}
...
<div class="modal-footer">
	...
	{
		echo modal_anchor(get_uri("items/modal_form"), "<i class='fa fa-pencil'></i> " . lang('edit_item'), ["class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit_item')]);
	}
	?>
   <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> <?php echo lang('close'); ?></button>
	...
	{
		echo js_anchor("<i class='fa fa-shopping-basket'></i> " . lang("add_to_cart"), ["class" => "btn btn-info item-add-to-cart-btn", "data-item_id" => $model_info->id]);
	}
	?>
</div>
