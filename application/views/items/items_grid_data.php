    ...
    <div id="<?php echo $next_container_id; ?>">
        <div class="text-center">
            ...
            if ($result_remaining > 0) {
                echo ajax_anchor(get_uri("items/grid_view/" . $next_page_offset . "/20/" . $category_id . "/" . $search), lang("load_more"), array("class" => "btn btn-default mt15 mb15 round pl15 pr15", "title" => lang("load_more"), "data-inline-loader" => "1", "data-real-target" => "#" . $next_container_id));
            }
            ?>
        </div>
    </div>
