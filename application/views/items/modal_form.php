<?php echo form_open(get_uri("items/save"), ["id" => "item-form", "class" => "general-form", "role" => "form"]); ?>
<div id="items-dropzone" class="post-dropzone">
   <div class="modal-body clearfix">
      ...
      <div class="form-group">
         <div class="col-md-12 row pr0">
			 <?php
			 $this->load->view("includes/file_list", ["files" => $model_info->files, "image_only" => true]);
			 ?>
         </div>
      </div>
   ...
   <div class="modal-footer">
      <button class="btn btn-default upload-file-button pull-left btn-sm round" type="button" style="color:#7988a2"><i
                 class="fa fa-camera"></i> <?php echo lang("upload_image"); ?></button>
