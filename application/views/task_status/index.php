      ...
      <div class="col-sm-9 col-lg-10">
         <div class="panel panel-default">
            ...
            <ul data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
               ...
               <li><a role="presentation" href="<?php echo_uri("settings/tasks/"); ?>" data-target="#task-settings-tab"><?php echo lang('task_settings'); ?></a>
               </li>
               <div class="tab-title clearfix no-border">
                  <div class="title-button-group">
					  <?php echo modal_anchor(get_uri("task_status/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_task_status'), ["class" => "btn btn-default", "title" => lang('add_task_status')]); ?>
                  </div>
               </div>
            </ul>
