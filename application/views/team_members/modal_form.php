<?php echo form_open(get_uri("team_members/add_team_member"), ["id" => "team_member-form", "class" => "general-form", "role" => "form"]); ?>
      ...
      <div role="tabpanel" class="tab-pane" id="account-info-tab">
         ...
         <div class="form-group">
            ...
            <div class="col-md-9">
				...
				?>
               <div id="user-role-help-block" class="help-block ml10 hide"><i
