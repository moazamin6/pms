<div class="tab-content">
	<?php echo form_open(get_uri("team_members/save_general_info/" . $user_info->id), ["id" => "general-info-form", "class" => "general-form dashed-row white", "role" => "form"]); ?>
   <div class="panel">
      ...
      <div class="panel-body">
         ...
         <div class="form-group">
		  ...
		  <?php $this->load->view("custom_fields/form/prepare_context_fields", ["custom_fields" => $custom_fields, "label_column" => "col-md-2", "field_column" => " col-md-10"]); ?>
