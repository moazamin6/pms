<div class="panel">
   <div class="tab-title clearfix">
      ...
      <div class="title-button-group">
		  <?php
		  echo modal_anchor(get_uri("team_members/file_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_files'), ["class" => "btn btn-default", "title" => lang('add_files'), "data-post-user_id" => $user_id]);
		  ?>
      </div>
   </div>
