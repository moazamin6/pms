...
?>">
   <ul id="team-member-leave-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
      ...
      <li><a id="monthly-leaves-button" role="presentation" class="active" href="javascript:;"
             data-target="#team_member-monthly-leaves"><?php echo lang("monthly"); ?></a></li>
      <li><a role="presentation" href="<?php echo_uri("team_members/yearly_leaves/"); ?>"
             data-target="#team_member-yearly-leaves"><?php echo lang('yearly'); ?></a></li>
