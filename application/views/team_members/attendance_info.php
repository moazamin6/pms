...
?>">
   <ul id="team-member-attendance-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
      <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php
			  ...
			  ?></h4></li>
      <li><a id="monthly-attendance-button" role="presentation" class="active" href="javascript:;"
             data-target="#team_member-monthly-attendance"><?php echo lang("monthly"); ?></a></li>
      <li><a role="presentation" href="<?php echo_uri("team_members/weekly_attendance/"); ?>"
             data-target="#team_member-weekly-attendance"><?php echo lang('weekly'); ?></a></li>
      <li><a role="presentation" href="<?php echo_uri("team_members/custom_range_attendance/"); ?>"
             data-target="#team_member-custom-range-attendance"><?php echo lang('custom'); ?></a></li>
      <li><a role="presentation" href="<?php echo_uri("team_members/attendance_summary/" . $user_id); ?>"
             data-target="#team_member-attendance-summary"><?php echo lang('summary'); ?></a></li>

	   <?php if(isset($show_clock_in_out)){ ?>
          <li><a role="presentation" href="<?php echo_uri("attendance/clock_in_out"); ?>" data-target="#clock-in-out"><?php echo lang('clock_in_out'); ?></a>
          </li>
	   <?php } ?>
