<?php echo form_open(get_uri("team_members/send_invitation"), ["id" => "invitation-form", "class" => "general-form", "role" => "form"]); ?>
         ...
         <div class="send-invitation-field">
            <div class="send-invitation-form clearfix pb10">
               <div class="col-md-11 p0">
				...
				<?php echo js_anchor("<i class='fa fa-times'></i> ", ["class" => "remove-invitation delete ml10"]); ?>
            </div>
         </div>
		  <?php echo js_anchor("<i class='fa fa-plus-circle'></i> " . lang('add_more'), ["class" => "add-invitation", "id" => "add-more-invitation"]); ?>
      </div>
   </div>
   <br/>
</div>
