...
class Stripe
{
	...
	public function get_stripe_payment_intent_session($data = [], $login_user = 0)
	{
		...
		if(!$login_user && !validate_invoice_verification_code($verification_code, ["invoice_id" => $invoice_id, "client_id" => $client_id, "contact_id" => $contact_user_id]))
		{
			return false;
		}
