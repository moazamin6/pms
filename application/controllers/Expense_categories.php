...
class Expense_categories extends MY_Controller
{
	...
	private function _make_row($data)
	{
		return [
			...
			. js_anchor("<i class='fa fa-times fa-fw'></i>", ['title' => lang('delete_expenses_category'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("expense_categories/delete"), "data-action" => "delete"]),
		];
	}
