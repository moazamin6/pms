...
class Leave_types extends MY_Controller
{
	...
	private function _make_row($data)
	{
		return [
			...
			. js_anchor("<i class='fa fa-times fa-fw'></i>", ['title' => lang('delete_leave_type'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("leave_types/delete"), "data-action" => "delete"]),
		];
	}
