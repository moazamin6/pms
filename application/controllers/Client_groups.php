...
class Client_groups extends MY_Controller
{
	...
	private function _make_row($data)
	{
		return [
			...
			. js_anchor("<i class='fa fa-times fa-fw'></i>", ['title' => lang('delete_client_group'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("client_groups/delete"), "data-action" => "delete"]),
		];
	}
