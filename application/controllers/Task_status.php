...
class Task_status extends MY_Controller
{
	...
	private function _make_row($data)
	{
		...
		$delete = "";
		$edit = modal_anchor(get_uri("task_status/modal_form"), "<i class='fa fa-pencil'></i>", ["class" => "edit", "title" => lang('edit_task_status'), "data-post-id" => $data->id]);

		if(!$data->key_name)
		{
			$delete = js_anchor("<i class='fa fa-times fa-fw'></i>", ['title' => lang('delete_task_status'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("task_status/delete"), "data-action" => "delete-confirmation"]);
		}
