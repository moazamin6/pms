...
class Team extends MY_Controller
{
	...
	private function _make_row($data)
	{
		...
		return [
			$data->title,
			modal_anchor(get_uri("team/members_list"), $total_members, ["title" => lang('team_members'), "data-post-members" => $data->members]),
			modal_anchor(get_uri("team/modal_form"), "<i class='fa fa-pencil'></i>", ["class" => "edit", "title" => lang('edit_team'), "data-post-id" => $data->id])
			. js_anchor("<i class='fa fa-times fa-fw'></i>", ['title' => lang('delete_team'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("team/delete"), "data-action" => "delete"]),
		];
	}
