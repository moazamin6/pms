...
class Signin extends CI_Controller
{
	...
	function send_reset_password_mail()
	{
		...
		{
			echo json_encode(["success" => false, 'message' => lang("no_acount_found_with_this_email")]);
			return false;
		}
	}
	...
	function do_reset_password()
	{
		...
		if($valid_key)
		{
			...
			if($user->id && $this->Users_model->save($user_data, $user->id))
			{
				...
				echo json_encode(["success" => true, 'message' => lang("password_reset_successfully") . " " . anchor("signin", lang("signin"))]);
				return true;
			}
		}
		echo json_encode(["success" => false, 'message' => lang("error_occurred")]);
