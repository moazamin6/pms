...
class Google_Service_Drive_Resource_Teamdrives extends Google_Service_Resource
{
	 ...
	 */
	public function create($requestId, Google_Service_Drive_TeamDrive $postBody, $optParams = [])
	{
		$params = ['requestId' => $requestId, 'postBody' => $postBody];
		$params = array_merge($params, $optParams);
		return $this->call('create', [$params], "Google_Service_Drive_TeamDrive");
	}
	...
	public function get($teamDriveId, $optParams = [])
	{
		$params = ['teamDriveId' => $teamDriveId];
		$params = array_merge($params, $optParams);
		return $this->call('get', [$params], "Google_Service_Drive_TeamDrive");
	}
	...
	public function listTeamdrives($optParams = [])
	{
		$params = [];
		$params = array_merge($params, $optParams);
		return $this->call('list', [$params], "Google_Service_Drive_TeamDriveList");
	}
	 ...
	 * @return Google_Service_Drive_TeamDrive
	 */
	public function update($teamDriveId, Google_Service_Drive_TeamDrive $postBody, $optParams = [])
	{
		$params = ['teamDriveId' => $teamDriveId, 'postBody' => $postBody];
		$params = array_merge($params, $optParams);
		return $this->call('update', [$params], "Google_Service_Drive_TeamDrive");
	}
}
