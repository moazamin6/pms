...
class Google_Service_Drive_Resource_Changes extends Google_Service_Resource
{
	...
	public function getStartPageToken($optParams = [])
	{
		...
		return $this->call('getStartPageToken', [$params], "Google_Service_Drive_StartPageToken");
	}
	 ...
	 */
	public function watch($pageToken, Google_Service_Drive_Channel $postBody, $optParams = [])
	{
